...
/* =============================================================================
 * SEMANTIC SEARCH AND AI MODEL CONFIGURATION
 * =============================================================================
 * Configuration for semantic search models, warning suppression, and GPU
 * settings.
 */

/* AI Model Configuration */
#define SEMANTIC_SEARCH_PRIMARY_MODEL "hkunlp/instructor-large"
#define SEMANTIC_SEARCH_FALLBACK_MODEL "ollama:mxbai-embed-large"
...
#define SEMANTIC_SEARCH_BATCH_SIZE_CPU 10
#define SEMANTIC_SEARCH_MAX_GPU_MEMORY_GB 12
#define SEMANTIC_SEARCH_ENABLE_GPU_MONITORING true
 ...
 * =============================================================================
 * These macros provide compile-time validation for documentation
 * configuration.
 */
