...
#define ADC_CALIB_MODE_BINARY_MASK                                             \
  (ADC_CALIB_FACTOR_REGOFFSET_MASK) /* Mask to get binary value of calibration \
                                       mode: 0 for offset, 1 for linearity */
...
#define ADC_INJ_TRIG_EXTSEL_BITOFFSET_POS                                      \
  (2UL) /* Value equivalent to bitfield "ADC_JSQR_JEXTSEL" position in         \
           register */
...
#define ADC_CHANNEL_ID_NUMBER_BITOFFSET_POS                                    \
  (26UL) /* Value equivalent to bitfield "ADC_CHANNEL_ID_NUMBER_MASK" position \
            in register */
...
#define ADC_CHANNEL_19_SMP                                                     \
  (ADC_SMPR2_REGOFFSET |                                                       \
   ((27UL)                                                                     \
    << ADC_CHANNEL_SMPx_BITOFFSET_POS)) /* Value shifted is equivalent to      \
                                           bitfield "ADC_SMPR2_SMP19" position \
                                           in register */
...
#define VREFINT_CAL_ADDR                                                       \
  ((uint16_t                                                                   \
        *)(0x8fff810UL)) /* Internal voltage reference, address of parameter   \
...
#define VREFINT_CAL_ADDR                                                       \
  ((uint16_t                                                                   \
        *)(0x1FF1E860UL)) /* Internal voltage reference, address of parameter  \
                             VREFINT_CAL: VrefInt ADC raw data acquired at     \
                             temperature 30 DegC (tolerance: +-5 DegC), Vref+  \
                             = 3.3 V (tolerance: +-10 mV). */
#endif                    /* ADC_VER_V5_3 */
...
#define TEMPSENSOR_CAL1_ADDR                                                   \
  ((uint16_t                                                                   \
        *)(0x8fff814UL)) /* Internal temperature sensor, address of parameter  \
                            TS_CAL1: On STM32H7, temperature sensor ADC raw    \
                            data acquired at temperature  30 DegC (tolerance:  \
                            +-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL2_ADDR                                                   \
  ((uint16_t                                                                   \
        *)(0x8fff818UL)) /* Internal temperature sensor, address of parameter  \
                            TS_CAL2: On STM32H7, temperature sensor ADC raw    \
...
#define TEMPSENSOR_CAL1_ADDR                                                   \
  ((uint16_t                                                                   \
        *)(0x1FF1E820UL)) /* Internal temperature sensor, address of parameter \
                             TS_CAL1: On STM32H7, temperature sensor ADC raw   \
                             data acquired at temperature  30 DegC (tolerance: \
                             +-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
#define TEMPSENSOR_CAL2_ADDR                                                   \
  ((uint16_t                                                                   \
        *)(0x1FF1E840UL)) /* Internal temperature sensor, address of parameter \
                             TS_CAL2: On STM32H7, temperature sensor ADC raw   \
                             data acquired at temperature 110 DegC (tolerance: \
                             +-5 DegC), Vref+ = 3.3 V (tolerance: +-10 mV). */
#endif                    /* ADC_VER_V5_3 */
...
#define TEMPSENSOR_CAL2_TEMP                                                   \
  ((((DBGMCU->IDCODE) >> 16) <= ((uint32_t)0x1003)) ? 110L : 130L) /* Internal \
temperature sensor , temperature at which temperature sensor has been          \
calibrated in production for data into TEMPSENSOR_CAL2_ADDR 110 °C for        \
revision Y and 130 °C for revision V (tolerance: +-5 DegC) (unit: DegC). */
#else
#define TEMPSENSOR_CAL2_TEMP                                                   \
  (130L) /* Internal temperature sensor, temperature at which temperature      \
sensor has been calibrated in production for data into TEMPSENSOR_CAL2_ADDR    \
(tolerance: +-5 DegC) (unit: DegC). */
#endif   /* defined (STM32H742xx) || defined (STM32H743xx) || defined          \
            (STM32H753xx) */
...
/* Registers addresses with ADC linearity calibration content (programmed during
 * device production, specific to each device) */
 ...
 * @{
 */
#define LL_ADC_SetChannelPreSelection                                          \
  LL_ADC_SetChannelPreselection /* Alias of LL_ADC_SetChannelPreselection for  \
...
typedef struct {
  ...
  uint32_t
      DataTransferMode; /*!< Set ADC group regular conversion data transfer
                           mode: no transfer, transfer by DMA
                           (Limited/Unlimited) or DFSDM. This parameter can be a
                           value of @ref ADC_LL_EC_REG_DATA_TRANSFER_MODE
...
#define LL_ADC_FLAG_LDORDY                                                     \
  ADC_ISR_LDORDY /*!< ADC flag ADC LDO output voltage ready bit */
...
#define LL_ADC_BOOST_MODE_6MHZ25                                               \
  (0x00000000UL) /*!< Boost mode is configured for frequency <= 6.25Mhz */
#define LL_ADC_BOOST_MODE_12MHZ5                                               \
  (ADC_CR_BOOST_0) /*!< Boost mode is configured for 6.25Mhz < frequency       \
                      <= 12.5Mhz */
#define LL_ADC_BOOST_MODE_20MHZ                                                \
  (ADC_CR_BOOST_1) /*!< Boost mode is configured for 12.5Mhz < frequency <=    \
                      20Mhz   */
#define LL_ADC_BOOST_MODE_25MHZ                                                \
  ((ADC_CR_BOOST_0 << 2) | ADC_CR_BOOST_1) /*!< Boost mode is configured for   \
                                              20Mhz   < frequency <= 25Mhz */
#define LL_ADC_BOOST_MODE_50MHZ                                                \
  ((ADC_CR_BOOST_0 << 2) | ADC_CR_BOOST_1 |                                    \
   ADC_CR_BOOST_0) /*!< Boost mode is configured for frequency > 25Mhz */
/**
 * @}
 */
...
#define LL_ADC_CALIB_OFFSET                                                    \
  (ADC_CALIB_FACTOR_OFFSET_REGOFFSET) /*!< Calibration of ADC offset. Duration \
                                         of calibration of offset duration:    \
                                         1280 ADC clock cycles. For devices    \
                                         with differential mode available:     \
                                         Calibration of offset is specific to  \
                                         each of single-ended and differential \
                                         modes. */
#define LL_ADC_CALIB_LINEARITY                                                 \
  (ADC_CALIB_FACTOR_LINEARITY_REGOFFSET) /*!< Calibration of ADC linearity.    \
...
#define LL_ADC_CALIB_OFFSET_LINEARITY                                          \
  (ADC_CALIB_FACTOR_LINEARITY_REGOFFSET |                                      \
   ADC_CR_ADCALLIN) /*!< Calibration of ADC offset and linearity. Duration of  \
                       calibration of offset and linearity: 16384 ADC clock    \
                       cycles. For devices with differential mode available:   \
                       Calibration of offset is specific to each of            \
                       single-ended and differential modes, calibration of     \
                       linearity is common to both single-ended and            \
                       differential modes. */
/**
 * @}
 */

/** @defgroup ADC_LL_EC_CALIBRATION_LINEARITY_WORD  ADC instance - Calibration
 * linearity words
 * @{
 */
...
#define LL_ADC_RESOLUTION_14B_OPT                                              \
  (ADC_CFGR_RES_2 |                                                            \
   ADC_CFGR_RES_0) /*!< ADC resolution 14 bits optimized for power             \
                      consumption, available on for devices revision V only */
#define LL_ADC_RESOLUTION_12B_OPT                                              \
  (ADC_CFGR_RES_2 |                                                            \
   ADC_CFGR_RES_1) /*!< ADC resolution 12 bits optimized for power             \
                      consumption, available on for devices revision V only */
#endif
...
/*!< The resolution setting is managed internally in the driver:
        "LL_ADC_RESOLUTION_8B" definition: keep using the "100b" value
   (corresponding to STM32H74x/5x rev Y). Rev.V value "111b" is handled through
   functions "LL_ADC_SetResolution/LL_ADC_GetResolution"  with a dedicated check
   on DBGMCU IDCODE register */
#endif
#if defined(ADC_VER_V5_V90)
#define LL_ADC_RESOLUTION_6B                                                   \
  (ADC3_CFGR_RES_1 |                                                           \
   ADC3_CFGR_RES_0) /*!< ADC resolution  6 bits. Value available for ADC3 on   \
                       STM32H72xx/3xx devices only*/
#endif              /* ADC_VER_V5_V90 */
/**
 * @}
 */
...
#define LL_ADC_DATA_ALIGN_LEFT                                                 \
  (ADC3_CFGR_ALIGN) /*!< ADC conversion data alignment: left aligned           \
...
#define LL_ADC_LEFT_BIT_SHIFT_1                                                \
  (ADC_CFGR2_LSHIFT_0) /*!< ADC 1 bit shift left applied on the final ADC      \
                          conversion data */
#define LL_ADC_LEFT_BIT_SHIFT_2                                                \
  (ADC_CFGR2_LSHIFT_1) /*!< ADC 2 bits shift left applied on the final ADC     \
                          conversion data */
#define LL_ADC_LEFT_BIT_SHIFT_3                                                \
  (ADC_CFGR2_LSHIFT_1 |                                                        \
   ADC_CFGR2_LSHIFT_0) /*!< ADC 3 bits shift left applied on the final ADC     \
                          conversion data */
#define LL_ADC_LEFT_BIT_SHIFT_4                                                \
  (ADC_CFGR2_LSHIFT_2) /*!< ADC 4 bits shift left applied on the final ADC     \
                          conversion data */
#define LL_ADC_LEFT_BIT_SHIFT_5                                                \
  (ADC_CFGR2_LSHIFT_2 |                                                        \
   ADC_CFGR2_LSHIFT_0) /*!< ADC 5 bits shift left applied on the final ADC     \
                          conversion data */
#define LL_ADC_LEFT_BIT_SHIFT_6                                                \
  (ADC_CFGR2_LSHIFT_2 |                                                        \
   ADC_CFGR2_LSHIFT_1) /*!< ADC 6 bits shift left applied on the final ADC     \
                          conversion data */
#define LL_ADC_LEFT_BIT_SHIFT_7                                                \
  (ADC_CFGR2_LSHIFT_2 | ADC_CFGR2_LSHIFT_1 |                                   \
   ADC_CFGR2_LSHIFT_0) /*!< ADC 7 bits shift left applied on the final ADC     \
                          conversion data */
#define LL_ADC_LEFT_BIT_SHIFT_8                                                \
  (ADC_CFGR2_LSHIFT_3) /*!< ADC 8 bits shift left applied on the final ADC     \
                          conversion data */
#define LL_ADC_LEFT_BIT_SHIFT_9                                                \
  (ADC_CFGR2_LSHIFT_3 |                                                        \
   ADC_CFGR2_LSHIFT_0) /*!< ADC 9 bits shift left applied on the final ADC     \
                          conversion data */
#define LL_ADC_LEFT_BIT_SHIFT_10                                               \
  (ADC_CFGR2_LSHIFT_3 |                                                        \
   ADC_CFGR2_LSHIFT_1) /*!< ADC 10 bits shift left applied on the final ADC    \
                          conversion data */
...
#define LL_ADC_LEFT_BIT_SHIFT_12                                               \
  (ADC_CFGR2_LSHIFT_3 |                                                        \
   ADC_CFGR2_LSHIFT_2) /*!< ADC 12 bits shift left applied on the final ADC    \
                          conversion data */
...
#define LL_ADC_OFFSET_SIGNED_SATURATION_DISABLE                                \
  (0x00000000UL) /*!< ADC offset signed saturation is disabled (among ADC      \
                    selected offset number 1, 2, 3 or 4) */
#define LL_ADC_OFFSET_SIGNED_SATURATION_ENABLE                                 \
  (ADC_OFR1_SSATE) /*!< ADC offset signed saturation is enabled (among ADC     \
                      selected offset number 1, 2, 3 or 4) */
/**
 * @}
 */
...
#define LL_ADC_OFFSET_RSHIFT_DISABLE                                           \
  (0x00000000UL) /*!< ADC offset right shift is disabled (among ADC selected   \
                    offset number 1, 2, 3 or 4) */
#define LL_ADC_OFFSET_RSHIFT_ENABLE                                            \
  (ADC_CFGR2_RSHIFT1) /*!< ADC offset right shift is enabled (among ADC        \
                         selected offset number 1, 2, 3 or 4) */
/**
 * @}
 */
...
#define LL_ADC_OFFSET_SATURATION_DISABLE                                       \
  (0x00000000UL) /*!< ADC offset saturation is disabled (among ADC selected    \
                    offset number 1, 2, 3 or 4). On devices STM32H72xx and     \
                    STM32H73xx */
#define LL_ADC_OFFSET_SATURATION_ENABLE                                        \
  (ADC3_OFR1_SATEN) /*!< ADC offset saturation is enabled (among ADC selected  \
                       offset number 1, 2, 3 or 4). On devices STM32H72xx and  \
                       STM32H73xx */
/**
 * @}
...
#define LL_ADC_OFFSET_ENABLE                                                   \
  (ADC3_OFR1_OFFSET1_EN) /*!< ADC offset enabled (among ADC selected offset    \
                            number 1, 2, 3 or 4) */
/**
 * @}
 */
...
#define LL_ADC_OFFSET_SIGN_NEGATIVE                                            \
  (0x00000000UL) /*!< ADC offset is negative (among ADC selected offset number \
                    1, 2, 3 or 4). On devices STM32H72xx and STM32H73xx */
#define LL_ADC_OFFSET_SIGN_POSITIVE                                            \
  (ADC3_OFR1_OFFSETPOS) /*!< ADC offset is positive (among ADC selected offset \
                           number 1, 2, 3 or 4). On devices STM32H72xx and     \
                           STM32H73xx */
/**
 * @}
 */
...
#define LL_ADC_CHANNEL_19                                                      \
  (ADC_CHANNEL_19_NUMBER | ADC_CHANNEL_19_SMP |                                \
   ADC_CHANNEL_19_BITFIELD) /*!< ADC external channel (channel connected to    \
                               GPIO pin) ADCx_IN19 */
#if defined(ADC3)
#if defined(ADC_VER_V5_V90)
#define LL_ADC_CHANNEL_VREFINT                                                 \
  (LL_ADC_CHANNEL_18 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to VrefInt: \
                                  Internal voltage reference. On STM32H7, ADC  \
...
#define LL_ADC_CHANNEL_TEMPSENSOR                                              \
  (LL_ADC_CHANNEL_17 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to          \
                                  Temperature sensor. On STM32H7, ADC channel  \
                                  available only on ADC instance: ADC3. */
#define LL_ADC_CHANNEL_VBAT                                                    \
  (LL_ADC_CHANNEL_16 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Vbat/3:  \
                                  ...
                                  On STM32H7, ADC channel available only on    \
                                  ADC instance: ADC3. */
#else
#define LL_ADC_CHANNEL_VREFINT                                                 \
  (LL_ADC_CHANNEL_19 |                                                         \
...
#define LL_ADC_CHANNEL_TEMPSENSOR                                              \
  (LL_ADC_CHANNEL_18 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to          \
                                  Temperature sensor. On STM32H7, ADC channel  \
                                  available only on ADC instance: ADC2. */
#define LL_ADC_CHANNEL_VBAT                                                    \
  (LL_ADC_CHANNEL_14 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to Vbat/3:  \
                                  Vbat voltage through a divider ladder of     \
...
#define LL_ADC_CHANNEL_DAC1CH1_ADC2                                            \
  (LL_ADC_CHANNEL_16 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to DAC1     \
                                  channel 1, channel specific to ADC2 */
#define LL_ADC_CHANNEL_DAC1CH2_ADC2                                            \
  (LL_ADC_CHANNEL_17 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to DAC1     \
                                  channel 2, channel specific to ADC2 */
#if defined(DAC2)
/*!< Specific define for STM32H7A3xx and STM32HB3xx varieties of STM32H7XXX */
#define LL_ADC_CHANNEL_DAC2CH1_ADC2                                            \
  (LL_ADC_CHANNEL_15 |                                                         \
   ADC_CHANNEL_ID_INTERNAL_CH) /*!< ADC internal channel connected to DAC2     \
                                  channel 1, channel specific to ADC2 */
#endif
/**
 * @}
...
#define LL_ADC_REG_TRIG_EXT_EXTI_LINE11                                        \
  (ADC_CFGR_EXTSEL_2 | ADC_CFGR_EXTSEL_1 |                                     \
   ADC_REG_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     ...
                                     interrupt line 11 event. Trigger edge set \
...
#define LL_ADC_REG_DMA_TRANSFER_LIMITED                                        \
  (ADC_CFGR_DMNGT_0) /*!< ADC conversion data are transferred by DMA, in       \
...
#define LL_ADC3_REG_DMA_TRANSFER_NONE                                          \
  (0x00000000UL) /*!< ADC conversions are not transferred by DMA. On ADC3 of   \
                    devices STM32H72xx and STM32H73xx */
#define LL_ADC3_REG_DMA_TRANSFER_LIMITED                                       \
  (ADC3_CFGR_DMAEN) /*!< ADC conversion data are transferred by DMA, in        \
                       ...
                       to be used with DMA mode non-circular. On ADC3 of       \
                       devices STM32H72xx and STM32H73xx */
#define LL_ADC3_REG_DMA_TRANSFER_UNLIMITED                                     \
  (ADC3_CFGR_DMACFG |                                                          \
   ADC3_CFGR_DMAEN) /*!< ADC conversion data are transferred by DMA, in        \
                       ...
                       DMA mode circular. On ADC3 of devices STM32H72xx and    \
                       STM32H73xx*/
/**
 * @}
 */
...
#define LL_ADC_INJ_TRIG_EXT_LPTIM3_OUT                                         \
  (ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_2 |                                   \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group injected conversion trigger   \
                                     from external peripheral: LPTIM3 OUT      \
                                     event. 4 event (capture compare: input    \
                                     capture or output capture). Trigger edge  \
                                     set to rising edge (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM23_TRGO                                         \
  (ADC_JSQR_JEXTSEL_4 | ADC_JSQR_JEXTSEL_2 | ADC_JSQR_JEXTSEL_0 |              \
   ADC_INJ_TRIG_EXT_EDGE_DEFAULT) /*!< ADC group regular conversion trigger    \
                                     from external peripheral: TIM23 TRGO      \
                                     event. Trigger edge set to rising edge    \
                                     (default setting). */
#define LL_ADC_INJ_TRIG_EXT_TIM24_TRGO                                         \
...
#define LL_ADC_SAMPLINGTIME_16CYCLES_5                                         \
  (ADC_SMPR2_SMP10_1 |                                                         \
   ADC_SMPR2_SMP10_0) /*!< Sampling time 16.5 ADC clock cycles */
...
#define LL_ADC_SAMPLINGTIME_64CYCLES_5                                         \
  (ADC_SMPR2_SMP10_2 |                                                         \
   ADC_SMPR2_SMP10_0) /*!< Sampling time 64.5 ADC clock cycles */
#define LL_ADC_SAMPLINGTIME_387CYCLES_5                                        \
  (ADC_SMPR2_SMP10_2 |                                                         \
   ADC_SMPR2_SMP10_1) /*!< Sampling time 387.5 ADC clock cycles */
...
#define LL_ADC_SAMPLINGTIME_ADC3_2CYCLES_5                                     \
  (0x00000000UL) /*!< Sampling time 2.5 ADC clock cycles. On ADC3 of devices   \
                    STM32H72xx and STM32H73xx */
#define LL_ADC_SAMPLINGTIME_ADC3_6CYCLES_5                                     \
  (ADC_SMPR2_SMP10_0) /*!< Sampling time 6.5 ADC clock cycles. On ADC3 of      \
                         devices STM32H72xx and STM32H73xx */
#define LL_ADC_SAMPLINGTIME_ADC3_12CYCLES_5                                    \
  (ADC_SMPR2_SMP10_1) /*!< Sampling time 12.5 ADC clock cycles. On ADC3 of     \
                         devices STM32H72xx and STM32H73xx */
#define LL_ADC_SAMPLINGTIME_ADC3_24CYCLES_5                                    \
  (ADC_SMPR2_SMP10_1 |                                                         \
   ADC_SMPR2_SMP10_0) /*!< Sampling time 24.5 ADC clock cycles. On ADC3 of     \
                         devices STM32H72xx and STM32H73xx */
#define LL_ADC_SAMPLINGTIME_ADC3_47CYCLES_5                                    \
  (ADC_SMPR2_SMP10_2) /*!< Sampling time 47.5 ADC clock cycles. On ADC3 of     \
                         devices STM32H72xx and STM32H73xx */
#define LL_ADC_SAMPLINGTIME_ADC3_92CYCLES_5                                    \
  (ADC_SMPR2_SMP10_2 |                                                         \
   ADC_SMPR2_SMP10_0) /*!< Sampling time 92.5 ADC clock cycles. On ADC3 of     \
                         devices STM32H72xx and STM32H73xx */
#define LL_ADC_SAMPLINGTIME_ADC3_247CYCLES_5                                   \
  (ADC_SMPR2_SMP10_2 |                                                         \
   ADC_SMPR2_SMP10_1) /*!< Sampling time 247.5 ADC clock cycles. On ADC3 of    \
                         devices STM32H72xx and STM32H73xx */
#define LL_ADC_SAMPLINGTIME_ADC3_640CYCLES_5                                   \
  (ADC_SMPR2_SMP10_2 | ADC_SMPR2_SMP10_1 |                                     \
   ADC_SMPR2_SMP10_0) /*!< Sampling time 640.5 ADC clock cycles. On ADC3 of    \
                         devices STM32H72xx and STM32H73xx */
/**
 * @}
 */
...
#define LL_ADC_AWD_CHANNEL_19_REG                                              \
  ((LL_ADC_CHANNEL_19 & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |               \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC external       \
                        channel (channel connected to GPIO pin) ADCx_IN19,     \
                        converted by group regular only */
...
#define LL_ADC_AWD_CH_VBAT_REG                                                 \
  ((LL_ADC_CHANNEL_VBAT & ADC_CHANNEL_ID_MASK) | ADC_CFGR_AWD1EN |             \
   ADC_CFGR_AWD1SGL) /*!< ADC analog watchdog monitoring of ADC internal       \
                        channel connected to Vbat/4: Vbat voltage through a    \
                        divider ladder of factor 1/4 to have Vbat always below \
...
#define LL_ADC_AWD_FILTERING_NONE                                              \
  (0x00000000UL) /*!< ADC analog watchdog no filtering, one out-of-window      \
                    sample is needed to raise flag or interrupt. On ADC3 of    \
                    devices STM32H72xx and STM32H73xx */
#define LL_ADC_AWD_FILTERING_2SAMPLES                                          \
  (ADC3_TR1_AWDFILT_0) /*!< ADC analog watchdog 2 consecutives out-of-window   \
                          samples are needed to raise flag or interrupt. On    \
                          ADC3 of devices STM32H72xx and STM32H73xx */
#define LL_ADC_AWD_FILTERING_3SAMPLES                                          \
  (ADC3_TR1_AWDFILT_1) /*!< ADC analog watchdog 3 consecutives out-of-window   \
                          samples are needed to raise flag or interrupt. On    \
                          ADC3 of devices STM32H72xx and STM32H73xx */
#define LL_ADC_AWD_FILTERING_4SAMPLES                                          \
  (ADC3_TR1_AWDFILT_1 |                                                        \
   ADC3_TR1_AWDFILT_0) /*!< ADC analog watchdog 4 consecutives out-of-window   \
                          samples are needed to raise flag or interrupt. On    \
                          ADC3 of devices STM32H72xx and STM32H73xx */
#define LL_ADC_AWD_FILTERING_5SAMPLES                                          \
  (ADC3_TR1_AWDFILT_2) /*!< ADC analog watchdog 5 consecutives out-of-window   \
                          samples are needed to raise flag or interrupt. On    \
                          ADC3 of devices STM32H72xx and STM32H73xx */
#define LL_ADC_AWD_FILTERING_6SAMPLES                                          \
  (ADC3_TR1_AWDFILT_2 |                                                        \
   ADC3_TR1_AWDFILT_0) /*!< ADC analog watchdog 6 consecutives out-of-window   \
                          samples are needed to raise flag or interrupt. On    \
                          ADC3 of devices STM32H72xx and STM32H73xx */
#define LL_ADC_AWD_FILTERING_7SAMPLES                                          \
  (ADC3_TR1_AWDFILT_2 |                                                        \
   ADC3_TR1_AWDFILT_1) /*!< ADC analog watchdog 7 consecutives out-of-window   \
                          samples are needed to raise flag or interrupt. On    \
                          ADC3 of devices STM32H72xx and STM32H73xx */
#define LL_ADC_AWD_FILTERING_8SAMPLES                                          \
  (ADC3_TR1_AWDFILT_2 | ADC3_TR1_AWDFILT_1 |                                   \
   ADC3_TR1_AWDFILT_0) /*!< ADC analog watchdog 8 consecutives out-of-window   \
                          samples are needed to raise flag or interrupt. On    \
                          ADC3 of devices STM32H72xx and STM32H73xx */
/**
 * @}
...
#define LL_ADC_OVS_RATIO_4                                                     \
  (ADC3_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 4 (4 ADC conversions are  \
...
#define LL_ADC_OVS_RATIO_8                                                     \
  (ADC3_CFGR2_OVSR_1) /*!< ADC oversampling ratio of 8 (8 ADC conversions are  \
                         performed, sum of these conversions data is computed  \
                         to result as the ADC oversampling conversion data     \
                         (before potential shift) */
#define LL_ADC_OVS_RATIO_16                                                    \
  (ADC3_CFGR2_OVSR_1 |                                                         \
   ADC3_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 16 (16 ADC conversions    \
...
#define LL_ADC_OVS_RATIO_32                                                    \
  (ADC3_CFGR2_OVSR_2) /*!< ADC oversampling ratio of 32 (32 ADC conversions    \
                         are performed, sum of these conversions data is       \
                         computed to result as the ADC oversampling conversion \
                         data (before potential shift) */
#define LL_ADC_OVS_RATIO_64                                                    \
  (ADC3_CFGR2_OVSR_2 |                                                         \
   ADC3_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 64 (64 ADC conversions    \
                         are performed, sum of these conversions data is       \
                         computed to result as the ADC oversampling conversion \
                         data (before potential shift) */
#define LL_ADC_OVS_RATIO_128                                                   \
  (ADC3_CFGR2_OVSR_2 |                                                         \
   ADC3_CFGR2_OVSR_1) /*!< ADC oversampling ratio of 128 (128 ADC conversions  \
                         are performed, sum of these conversions data is       \
                         computed to result as the ADC oversampling conversion \
                         data (before potential shift) */
#define LL_ADC_OVS_RATIO_256                                                   \
  (ADC3_CFGR2_OVSR_2 | ADC3_CFGR2_OVSR_1 |                                     \
   ADC3_CFGR2_OVSR_0) /*!< ADC oversampling ratio of 256 (256 ADC conversions  \
                         are performed, sum of these conversions data is       \
                         computed to result as the ADC oversampling conversion \
                         data (before potential shift) */
/**
...
#define LL_ADC_OVS_SHIFT_RIGHT_9                                               \
  (ADC_CFGR2_OVSS_3 |                                                          \
   ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 9 (sum of the ADC          \
                        conversions data is divided by 512 to result as the    \
                        ADC oversampling conversion data) */
#define LL_ADC_OVS_SHIFT_RIGHT_10                                              \
  (ADC_CFGR2_OVSS_3 |                                                          \
   ADC_CFGR2_OVSS_1) /*!< ADC oversampling shift of 10 (sum of the ADC         \
                        conversions data is divided by 1024 to result as the   \
                        ADC oversampling conversion data) */
#define LL_ADC_OVS_SHIFT_RIGHT_11                                              \
  (ADC_CFGR2_OVSS_3 | ADC_CFGR2_OVSS_1 |                                       \
   ADC_CFGR2_OVSS_0) /*!< ADC oversampling shift of 11 (sum of the ADC         \
                        conversions data is divided by 2048 to result as the   \
                        ADC oversampling conversion data) */
/**
 * @}
 */
...
#define LL_ADC_MULTI_REG_DMA_RES_32_10B                                        \
  (ADC_CCR_DAMDF_1) /*!< ADC multimode group regular conversions are           \
                       ...
                       of ADC master). Setting for ADC resolution of 32 (16x2) \
                       down to 10 bits */
...
#define LL_ADC_MULTI_TWOSMP_DELAY_1CYCLE_5                                     \
  (0x00000000UL) /*!< ADC multimode delay between two sampling phases: 1.5 ADC \
                    clock cycle for all resolution                    */
#define LL_ADC_MULTI_TWOSMP_DELAY_2CYCLES_5                                    \
  (ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 2.5  \
                       ADC clock cycles for all resolution */
#define LL_ADC_MULTI_TWOSMP_DELAY_3CYCLES_5                                    \
  (ADC_CCR_DELAY_1) /*!< ADC multimode delay between two sampling phases: 3.5  \
                       ADC clock cycles for all resolution */
#define LL_ADC_MULTI_TWOSMP_DELAY_4CYCLES_5                                    \
  (ADC_CCR_DELAY_1 |                                                           \
   ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 4.5  \
                       ADC clock cycles for 16, 14, 12 or 10 bits resolution   \
                     */
#define LL_ADC_MULTI_TWOSMP_DELAY_4CYCLES_5_8_BITS                             \
  (ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                                         \
   ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 4.5  \
                       ADC clock cycles  for 8 bits resolution */
#define LL_ADC_MULTI_TWOSMP_DELAY_5CYCLES_5                                    \
  (ADC_CCR_DELAY_2) /*!< ADC multimode delay between two sampling phases: 5.5  \
                       ADC clock cycles for 16, 14, 12 bits resolution */
#define LL_ADC_MULTI_TWOSMP_DELAY_5CYCLES_5_10_BITS                            \
  (ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                                         \
   ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 5.5  \
                       ADC clock cycles for 10 bits resolution */
#define LL_ADC_MULTI_TWOSMP_DELAY_6CYCLES                                      \
  (ADC_CCR_DELAY_3) /*!< ADC multimode delay between two sampling phases: 6    \
                       ADC clock cycles for 10 or 8 bits resolution */
#define LL_ADC_MULTI_TWOSMP_DELAY_6CYCLES_5                                    \
  (ADC_CCR_DELAY_2 |                                                           \
   ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 6.5  \
                       ADC clock cycles for 16 or 14 bits resolution */
#define LL_ADC_MULTI_TWOSMP_DELAY_6CYCLES_5_12_BITS                            \
  (ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                                         \
   ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 6.5  \
                       ADC clock cycles for 12 bits resolution */
#define LL_ADC_MULTI_TWOSMP_DELAY_7CYCLES_5                                    \
  (ADC_CCR_DELAY_2 | ADC_CCR_DELAY_1 |                                         \
   ADC_CCR_DELAY_0) /*!< ADC multimode delay between two sampling phases: 7.5  \
                       ADC clock cycles for 16 bits resolution */
#define LL_ADC_MULTI_TWOSMP_DELAY_8CYCLES                                      \
  (ADC_CCR_DELAY_3) /*!< ADC multimode delay between two sampling phases: 8    \
                       ADC clock cycles for 12 bits resolution */
...
#define LL_ADC_DELAY_INTERNAL_REGUL_STAB_US                                    \
  (10UL) /*!< Delay for ADC stabilization time (ADC voltage regulator start-up \
            time) */
...
/* according to Data sheet), linearity set/clear bit delay MAX = 6 / f_ADC + 3
 * cycles AHB  */
/*           6 / 4577 = 1,311ms */
...
#if defined(ADC_VER_V5_V90)
/**
 * @brief  Helper macro to convert the resolution defines to STM32H73x/2x ADC3
 * registers values value corresponding to the ADC3 resolution according to the
 * STM32H73x/2x RefMan.
 ...
 *         @arg ADC_CFGR_RES_0 = 0x00000004  (value corresponding to ADC3 10
 * bits)
...
#define __LL_ADC12_RESOLUTION_TO_ADC3(__ADC_RESOLUTION__)                      \
  (((__ADC_RESOLUTION__) == LL_ADC_RESOLUTION_12B)   ? (0x00000000UL)          \
   : ((__ADC_RESOLUTION__) == LL_ADC_RESOLUTION_10B) ? (ADC_CFGR_RES_0)        \
   : ((__ADC_RESOLUTION__) == LL_ADC_RESOLUTION_8B)  ? (ADC_CFGR_RES_1)        \
 ...
 *         @arg @ref LL_ADC_RESOLUTION_8B
 *         @arg @ref LL_ADC_RESOLUTION_6B
 * @retval ADC conversion data equivalent voltage value (unit: digital value of
 * ADC conversion bitfield)
 */
 ...
 * @retval ADC conversion data to the requested resolution
 */
#define __LL_ADC_CONVERT_DATA_RESOLUTION_ADC3(                                 \
    __DATA__, __ADC_RESOLUTION_CURRENT__, __ADC_RESOLUTION_TARGET__)           \
  (((__DATA__) << ((__ADC_RESOLUTION_CURRENT__) >>                             \
                   (ADC_CFGR_RES_BITOFFSET_POS_ADC3 - 1UL))) >>                \
...
#define __LL_ADC_CALC_VREFANALOG_VOLTAGE(__VREFINT_ADC_DATA__,                 \
  ...
  (((uint32_t)(*VREFINT_CAL_ADDR) * VREFINT_CAL_VREF) /                        \
   __LL_ADC_CONVERT_DATA_RESOLUTION(                                           \
       (__VREFINT_ADC_DATA__), (__ADC_RESOLUTION__), LL_ADC_RESOLUTION_16B))
 ...
 * sensor slope typical value (unit: uV/DegCelsius). On STM32H7, refer to device
 ...
 * below) (unit: mV). On STM32H7, refer to device datasheet parameter "V30"
...
#if defined(ADC_VER_V5_V90)
  MODIFY_REG(ADCx->CALFACT_RES13, SingleDiff & ADC_SINGLEDIFF_CALIB_FACTOR_MASK,
             CalibrationFactor
...
LL_ADC_SetCalibrationLinearFactor(ADC_TypeDef *ADCx, uint32_t LinearityWord,
  ...
  if (ADCx != ADC3) {
    ...
    MODIFY_REG(ADCx->CALFACT2_RES14, ADC_CALFACT2_LINCALFACT,
               CalibrationFactor);
...
__STATIC_INLINE void LL_ADC_SetResolution(ADC_TypeDef *ADCx,
  ...
  if (ADCx == ADC3) {
    MODIFY_REG(ADCx->CFGR, ADC3_CFGR_RES,
               ((__LL_ADC12_RESOLUTION_TO_ADC3(Resolution) &
                 (ADC_CFGR_RES_1 | ADC_CFGR_RES_0))
                << 1UL));
  } else {
 ...
 * @note   Caution: Channel selections is dependent to ADC instance and IP
 * version: For STM32H72x/3x This is applicable only for ADC1/ADC2 For Rest of
 * STM32H7xxx This is applicable only all the ADCs instances.
 *
 * @param  ADCx ADC instance
 ...
 * @note   Caution: Channel selections is dependent to ADC instance and IP
 * version: For STM32H72x/3x This is applicable only for ADC1/ADC2 For Rest of
 * STM32H7xxx This is applicable on all the ADCs instances.
 *
 * @param  ADCx ADC instance
 * @param  Channel This parameter can be one of the following values:
 *         @arg @ref LL_ADC_CHANNEL_0
 ...
 *         @arg @ref LL_ADC_CHANNEL_18
 *         @arg @ref LL_ADC_CHANNEL_19
 * @retval the preselection state of Channel (!= 0 : pre-selected, == 0 : not
 * pre-selected)
 */
 ...
 *         offset has to be left-aligned on bit 15 (handling maximum ADC
 * resolution 16 bit), the LSB (right bits) are set to 0.
...
__STATIC_INLINE void LL_ADC_SetOffset(ADC_TypeDef *ADCx, uint32_t Offsety,
  ...
  if (ADCx == ADC3) {
    MODIFY_REG(*preg,
               ...
               ADC3_OFR1_OFFSET1_EN | (Channel & ADC_CHANNEL_ID_NUMBER_MASK) |
                   OffsetLevel);
  } else
#endif /* ADC_VER_V5_V90 */
  {
...
__STATIC_INLINE void LL_ADC_SetOffsetSaturation(ADC_TypeDef *ADCx,
  ...
  if (ADCx == ADC3) {
    ...
    MODIFY_REG(*preg, ADC3_OFR1_SATEN, OffsetSaturation);
  }
}
...
__STATIC_INLINE void LL_ADC_SetOffsetSign(ADC_TypeDef *ADCx, uint32_t Offsety,
  ...
  if (ADCx == ADC3) {
    ...
    MODIFY_REG(*preg, ADC3_OFR1_OFFSETPOS, OffsetSign);
  }
}
...
__STATIC_INLINE void LL_ADC_SetOffsetState(ADC_TypeDef *ADCx, uint32_t Offsety,
  ...
  __IO uint32_t *preg = __ADC_PTR_REG_OFFSET(ADCx->OFR1, Offsety);
  if (ADCx == ADC3) {
    MODIFY_REG(*preg, ADC3_OFR1_OFFSET1_EN, OffsetState);
  } else {
    MODIFY_REG(*preg, ADC_OFR1_SSATE, OffsetState);
  }
}
...
__STATIC_INLINE uint32_t LL_ADC_IsEnabledDMAReq(const ADC_TypeDef *ADCx) {
  return ((READ_BIT(ADCx->CFGR, ADC3_CFGR_DMAEN) == (ADC3_CFGR_DMAEN)) ? 1UL
                                                                       : 0UL);
}
/**
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_REG_GetDMATransferMode(const ADC_TypeDef *ADCx) {
  if (ADCx == ADC3) {
 ...
 */
__STATIC_INLINE uint32_t
LL_ADC_REG_GetDataTransferMode(const ADC_TypeDef *ADCx) {
...
__STATIC_INLINE void LL_ADC_SetChannelSingleDiff(ADC_TypeDef *ADCx,
  ...
  if (ADCx == ADC3) {
    MODIFY_REG(ADCx->LTR2_DIFSEL, Channel & ADC_SINGLEDIFF_CHANNEL_MASK,
               (Channel & ADC_SINGLEDIFF_CHANNEL_MASK) &
                   (ADC_DIFSEL_DIFSEL >>
                    (SingleDiff & ADC_SINGLEDIFF_CHANNEL_SHIFT_MASK)));
  } else {
    MODIFY_REG(ADCx->DIFSEL_RES12, Channel & ADC_SINGLEDIFF_CHANNEL_MASK,
               (Channel & ADC_SINGLEDIFF_CHANNEL_MASK) &
                   (ADC_DIFSEL_DIFSEL >>
                    (SingleDiff & ADC_SINGLEDIFF_CHANNEL_SHIFT_MASK)));
  }
...
__STATIC_INLINE uint32_t LL_ADC_GetChannelSingleDiff(const ADC_TypeDef *ADCx,
                                                     uint32_t Channel) {
#if defined(ADC_VER_V5_V90)
  return (uint32_t)(READ_BIT(ADCx->DIFSEL_RES12,
                             (Channel & ADC_SINGLEDIFF_CHANNEL_MASK)));
#else
...
__STATIC_INLINE void LL_ADC_SetAnalogWDThresholds(ADC_TypeDef *ADCx,
  ...
  if (ADCx == ADC3) {
    ...
    MODIFY_REG(*preg,
               ...
               AWDThresholdValue << (((AWDThresholdsHighLow * ADC3_TR1_HT1) &
...
__STATIC_INLINE uint32_t LL_ADC_GetAnalogWDThresholds(
  ...
  if (ADCx == ADC3) {
    ...
    return (uint32_t)(READ_BIT(*preg, (ADC3_TR1_LT1 << (AWDThresholdsHighLow *
                                                        ADC3_TR1_HT1_Pos))) >>
...
LL_ADC_ConfigAnalogWDThresholds(ADC_TypeDef *ADCx, uint32_t AWDy,
  ...
  if (ADCx == ADC3) {
    ...
    MODIFY_REG(*preg, ADC3_TR1_HT1 | ADC3_TR1_LT1,
               (AWDThresholdHighValue << ADC3_TR1_HT1_Pos) |
    ...
    __IO uint32_t *preg2 = __ADC_PTR_REG_OFFSET(
        ADCx->LTR1_TR1,
        (((AWDy & ADC_AWD_TRX_REGOFFSET_MASK) >> ADC_AWD_TRX_REGOFFSET_POS) *
         2UL) +
            ((AWDy & ADC_AWD_TR12_REGOFFSETGAP_MASK) *
