...
typedef struct {
  uint32_t
      PeriphOrM2MSrcAddress; /*!< Specifies the peripheral base address for BDMA
  ...
  uint32_t Direction; /*!< Specifies if the data will be transferred from memory
                         ...
                         BDMA_LL_EC_DIRECTION

                           This feature can be modified afterwards using unitary
                         function @ref LL_BDMA_SetDataTransferDirection(). */
  ...
  uint32_t
      PeriphOrM2MSrcDataSize; /*!< Specifies the Peripheral data size alignment
                                 ...
                                 @ref BDMA_LL_EC_PDATAALIGN

                                   This feature can be modified afterwards using
                                 unitary function @ref LL_BDMA_SetPeriphSize().
                               */
  ...
  uint32_t
      MemoryOrM2MDstDataSize; /*!< Specifies the Memory data size alignment or
                                 ...
                                 value of @ref BDMA_LL_EC_MDATAALIGN

                                   This feature can be modified afterwards using
                                 unitary function @ref LL_BDMA_SetMemorySize().
                               */
  ...
  uint32_t
      PeriphRequest; /*!< Specifies the peripheral request.
                        ...
                        DMAMUX_LL_EC_REQUEST
                          ...
                          This feature can be modified afterwards using unitary
                        function @ref LL_BDMA_SetPeriphRequest(). */
  ...
  uint32_t
      Priority; /*!< Specifies the channel priority level.
                     ...
                     This feature can be modified afterwards using unitary
                   function @ref LL_BDMA_SetChannelPriorityLevel(). */

  uint32_t DoubleBufferMode; /*!< Specifies the double buffer mode.
                                  This parameter can be a value of @ref
                                BDMA_LL_EC_DOUBLEBUFFER_MODE
  ...
  uint32_t
      TargetMemInDoubleBufferMode; /*!< Specifies the target memory in double
                                      ...
                                      of @ref BDMA_LL_EC_CURRENTTARGETMEM
...
#define __LL_BDMA_GET_CHANNEL(__CHANNEL_INSTANCE__)                            \
  (((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA_Channel0))             \
       ? LL_BDMA_CHANNEL_0                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA1_Channel0))          \
       ? LL_BDMA_CHANNEL_0                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA_Channel1))           \
       ? LL_BDMA_CHANNEL_1                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA1_Channel1))          \
       ? LL_BDMA_CHANNEL_1                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA_Channel2))           \
       ? LL_BDMA_CHANNEL_2                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA1_Channel2))          \
       ? LL_BDMA_CHANNEL_2                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA_Channel3))           \
       ? LL_BDMA_CHANNEL_3                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA1_Channel3))          \
       ? LL_BDMA_CHANNEL_3                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA_Channel4))           \
       ? LL_BDMA_CHANNEL_4                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA1_Channel4))          \
       ? LL_BDMA_CHANNEL_4                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA_Channel5))           \
       ? LL_BDMA_CHANNEL_5                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA1_Channel5))          \
       ? LL_BDMA_CHANNEL_5                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA_Channel6))           \
       ? LL_BDMA_CHANNEL_6                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA1_Channel6))          \
       ? LL_BDMA_CHANNEL_6                                                     \
   : ((uint32_t)(__CHANNEL_INSTANCE__) == ((uint32_t)BDMA_Channel7))           \
       ? LL_BDMA_CHANNEL_7                                                     \
       : LL_BDMA_CHANNEL_7)
#else
#define __LL_BDMA_GET_CHANNEL(__CHANNEL_INSTANCE__)                            \
...
#define __LL_BDMA_GET_CHANNEL_INSTANCE(__BDMA_INSTANCE__, __CHANNEL__)         \
  ((((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA)) &&                     \
    ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_0)))                \
       ? BDMA_Channel0                                                         \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA1)) &&                  \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_0)))              \
       ? BDMA1_Channel0                                                        \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA)) &&                   \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_1)))              \
       ? BDMA_Channel1                                                         \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA1)) &&                  \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_1)))              \
       ? BDMA1_Channel1                                                        \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA)) &&                   \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_2)))              \
       ? BDMA_Channel2                                                         \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA1)) &&                  \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_2)))              \
       ? BDMA1_Channel2                                                        \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA)) &&                   \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_3)))              \
       ? BDMA_Channel3                                                         \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA1)) &&                  \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_3)))              \
       ? BDMA1_Channel3                                                        \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA)) &&                   \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_4)))              \
       ? BDMA_Channel4                                                         \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA1)) &&                  \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_4)))              \
       ? BDMA1_Channel4                                                        \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA)) &&                   \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_5)))              \
       ? BDMA_Channel5                                                         \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA1)) &&                  \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_5)))              \
       ? BDMA1_Channel5                                                        \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA)) &&                   \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_6)))              \
       ? BDMA_Channel6                                                         \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA1)) &&                  \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_6)))              \
       ? BDMA1_Channel6                                                        \
   : (((uint32_t)(__BDMA_INSTANCE__) == ((uint32_t)BDMA)) &&                   \
      ((uint32_t)(__CHANNEL__) == ((uint32_t)LL_BDMA_CHANNEL_7)))              \
       ? BDMA_Channel7                                                         \
       : BDMA1_Channel7)
#else
#define __LL_BDMA_GET_CHANNEL_INSTANCE(__BDMA_INSTANCE__, __CHANNEL__)         \
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_EnableChannel(const BDMA_TypeDef *BDMAx,
                                           uint32_t Channel) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_DisableChannel(const BDMA_TypeDef *BDMAx,
                                            uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 */
__STATIC_INLINE uint32_t LL_BDMA_IsEnabledChannel(const BDMA_TypeDef *BDMAx,
                                                  uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;

  return ((READ_BIT(((BDMA_Channel_TypeDef *)(bdma_base_addr +
                                              LL_BDMA_CH_OFFSET_TAB[Channel]))
                        ->CCR,
 ...
 *         @arg @ref LL_BDMA_DOUBLEBUFFER_MODE_DISABLE or @ref
 * LL_BDMA_DOUBLEBUFFER_MODE_ENABLE
 *         @arg @ref LL_BDMA_CURRENTTARGETMEM0 or @ref LL_BDMA_CURRENTTARGETMEM1
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_ConfigTransfer(const BDMA_TypeDef *BDMAx,
                                            uint32_t Channel,
                                            uint32_t Configuration) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;

  MODIFY_REG(((BDMA_Channel_TypeDef *)(bdma_base_addr +
                                       LL_BDMA_CH_OFFSET_TAB[Channel]))
                 ->CCR,
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetDataTransferDirection(const BDMA_TypeDef *BDMAx,
                                                      uint32_t Channel,
                                                      uint32_t Direction) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
...
LL_BDMA_GetDataTransferDirection(const BDMA_TypeDef *BDMAx, uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetMode(const BDMA_TypeDef *BDMAx,
 ...
 *         @arg @ref LL_BDMA_MODE_CIRCULAR
 */
__STATIC_INLINE uint32_t LL_BDMA_GetMode(const BDMA_TypeDef *BDMAx,
                                         uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetPeriphIncMode(const BDMA_TypeDef *BDMAx,
                                              uint32_t Channel,
  ...
  MODIFY_REG(((BDMA_Channel_TypeDef *)(bdma_base_addr +
                                       LL_BDMA_CH_OFFSET_TAB[Channel]))
                 ->CCR,
             BDMA_CCR_PINC, PeriphOrM2MSrcIncMode);
}
 ...
 *         @arg @ref LL_BDMA_PERIPH_NOINCREMENT
 */
__STATIC_INLINE uint32_t LL_BDMA_GetPeriphIncMode(const BDMA_TypeDef *BDMAx,
                                                  uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetMemoryIncMode(const BDMA_TypeDef *BDMAx,
                                              uint32_t Channel,
  ...
  MODIFY_REG(((BDMA_Channel_TypeDef *)(bdma_base_addr +
                                       LL_BDMA_CH_OFFSET_TAB[Channel]))
                 ->CCR,
             BDMA_CCR_MINC, MemoryOrM2MDstIncMode);
}
 ...
 *         @arg @ref LL_BDMA_MEMORY_NOINCREMENT
 */
__STATIC_INLINE uint32_t LL_BDMA_GetMemoryIncMode(const BDMA_TypeDef *BDMAx,
                                                  uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetPeriphSize(const BDMA_TypeDef *BDMAx,
                                           uint32_t Channel,
  ...
  MODIFY_REG(((BDMA_Channel_TypeDef *)(bdma_base_addr +
                                       LL_BDMA_CH_OFFSET_TAB[Channel]))
                 ->CCR,
             BDMA_CCR_PSIZE, PeriphOrM2MSrcDataSize);
}
 ...
 *         @arg @ref LL_BDMA_PDATAALIGN_WORD
 */
__STATIC_INLINE uint32_t LL_BDMA_GetPeriphSize(const BDMA_TypeDef *BDMAx,
                                               uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetMemorySize(const BDMA_TypeDef *BDMAx,
                                           uint32_t Channel,
  ...
  MODIFY_REG(((BDMA_Channel_TypeDef *)(bdma_base_addr +
                                       LL_BDMA_CH_OFFSET_TAB[Channel]))
                 ->CCR,
             BDMA_CCR_MSIZE, MemoryOrM2MDstDataSize);
}
 ...
 *         @arg @ref LL_BDMA_MDATAALIGN_WORD
 */
__STATIC_INLINE uint32_t LL_BDMA_GetMemorySize(const BDMA_TypeDef *BDMAx,
                                               uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetChannelPriorityLevel(const BDMA_TypeDef *BDMAx,
                                                     uint32_t Channel,
                                                     uint32_t Priority) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 */
__STATIC_INLINE uint32_t
LL_BDMA_GetChannelPriorityLevel(const BDMA_TypeDef *BDMAx, uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetDataLength(const BDMA_TypeDef *BDMAx,
 ...
 */
__STATIC_INLINE uint32_t LL_BDMA_GetDataLength(const BDMA_TypeDef *BDMAx,
                                               uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetCurrentTargetMem(const BDMA_TypeDef *BDMAx,
                                                 uint32_t Channel,
 ...
 *         @arg @ref LL_BDMA_CURRENTTARGETMEM1
 */
__STATIC_INLINE uint32_t LL_BDMA_GetCurrentTargetMem(const BDMA_TypeDef *BDMAx,
                                                     uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_EnableDoubleBufferMode(const BDMA_TypeDef *BDMAx,
                                                    uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_DisableDoubleBufferMode(const BDMA_TypeDef *BDMAx,
                                                     uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 */
__STATIC_INLINE uint32_t
LL_BDMA_IsEnabledDoubleBufferMode(const BDMA_TypeDef *BDMAx, uint32_t Channel) {
  register uint32_t bdma_base_addr = (uint32_t)BDMAx;

  return ((READ_BIT(((BDMA_Channel_TypeDef *)(bdma_base_addr +
                                              LL_BDMA_CH_OFFSET_TAB[Channel]))
                        ->CCR,
                    BDMA_CCR_DBM) == (BDMA_CCR_DBM))
              ? 1UL
              : 0UL);
}
 ...
 * address (LL_PPP_BDMA_GetRegAddr).
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_ConfigAddresses(const BDMA_TypeDef *BDMAx,
                                             uint32_t Channel,
                                             uint32_t SrcAddress,
                                             uint32_t DstAddress,
                                             uint32_t Direction) {
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetMemoryAddress(const BDMA_TypeDef *BDMAx,
                                              uint32_t Channel,
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetPeriphAddress(const BDMA_TypeDef *BDMAx,
                                              uint32_t Channel,
 ...
 * @retval Between Min_Data = 0 and Max_Data = 0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_BDMA_GetMemoryAddress(const BDMA_TypeDef *BDMAx,
                                                  uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;

  return (READ_REG(((BDMA_Channel_TypeDef *)(bdma_base_addr +
                                             LL_BDMA_CH_OFFSET_TAB[Channel]))
                       ->CM0AR));
}
 ...
 * @retval Between Min_Data = 0 and Max_Data = 0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_BDMA_GetPeriphAddress(const BDMA_TypeDef *BDMAx,
                                                  uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetM2MSrcAddress(const BDMA_TypeDef *BDMAx,
                                              uint32_t Channel,
                                              uint32_t MemoryAddress) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetM2MDstAddress(const BDMA_TypeDef *BDMAx,
                                              uint32_t Channel,
                                              uint32_t MemoryAddress) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval Between Min_Data = 0 and Max_Data = 0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_BDMA_GetM2MSrcAddress(const BDMA_TypeDef *BDMAx,
                                                  uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval Between Min_Data = 0 and Max_Data = 0xFFFFFFFF
 */
__STATIC_INLINE uint32_t LL_BDMA_GetM2MDstAddress(const BDMA_TypeDef *BDMAx,
                                                  uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetMemory1Address(const BDMA_TypeDef *BDMAx,
                                               uint32_t Channel,
                                               uint32_t Address) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 */
__STATIC_INLINE uint32_t LL_BDMA_GetMemory1Address(const BDMA_TypeDef *BDMAx,
                                                   uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_SetPeriphRequest(const BDMA_TypeDef *BDMAx,
                                              uint32_t Channel,
                                              uint32_t Request) {
  UNUSED(BDMAx);
  MODIFY_REG(
 ...
 * @note   (*) Availability depends on devices.
 */
__STATIC_INLINE uint32_t LL_BDMA_GetPeriphRequest(const BDMA_TypeDef *BDMAx,
                                                  uint32_t Channel) {
  UNUSED(BDMAx);
  return (READ_BIT(
      ((DMAMUX_Channel_TypeDef *)((uint32_t)((uint32_t)DMAMUX2_Channel0 +
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TC0(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TCIF0) == (BDMA_ISR_TCIF0)) ? 1UL
                                                                     : 0UL);
}
/**
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TC1(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TCIF1) == (BDMA_ISR_TCIF1)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TC2(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TCIF2) == (BDMA_ISR_TCIF2)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TC3(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TCIF3) == (BDMA_ISR_TCIF3)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TC4(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TCIF4) == (BDMA_ISR_TCIF4)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TC5(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TCIF5) == (BDMA_ISR_TCIF5)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TC6(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TCIF6) == (BDMA_ISR_TCIF6)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TC7(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TCIF7) == (BDMA_ISR_TCIF7)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_HT0(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_HTIF0) == (BDMA_ISR_HTIF0)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_HT1(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_HTIF1) == (BDMA_ISR_HTIF1)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_HT2(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_HTIF2) == (BDMA_ISR_HTIF2)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_HT3(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_HTIF3) == (BDMA_ISR_HTIF3)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_HT4(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_HTIF4) == (BDMA_ISR_HTIF4)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_HT5(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_HTIF5) == (BDMA_ISR_HTIF5)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_HT6(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_HTIF6) == (BDMA_ISR_HTIF6)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_HT7(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_HTIF7) == (BDMA_ISR_HTIF7)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TE0(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TEIF0) == (BDMA_ISR_TEIF0)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TE1(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TEIF1) == (BDMA_ISR_TEIF1)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TE2(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TEIF2) == (BDMA_ISR_TEIF2)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TE3(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TEIF3) == (BDMA_ISR_TEIF3)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TE4(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TEIF4) == (BDMA_ISR_TEIF4)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TE5(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TEIF5) == (BDMA_ISR_TEIF5)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TE6(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TEIF6) == (BDMA_ISR_TEIF6)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_BDMA_IsActiveFlag_TE7(const BDMA_TypeDef *BDMAx) {
  return ((READ_BIT(BDMAx->ISR, BDMA_ISR_TEIF7) == (BDMA_ISR_TEIF7)) ? 1UL
                                                                     : 0UL);
}
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_EnableIT_TC(const BDMA_TypeDef *BDMAx,
                                         uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_EnableIT_HT(const BDMA_TypeDef *BDMAx,
                                         uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_EnableIT_TE(const BDMA_TypeDef *BDMAx,
                                         uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_DisableIT_TC(const BDMA_TypeDef *BDMAx,
                                          uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_DisableIT_HT(const BDMA_TypeDef *BDMAx,
                                          uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval None
 */
__STATIC_INLINE void LL_BDMA_DisableIT_TE(const BDMA_TypeDef *BDMAx,
                                          uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_BDMA_IsEnabledIT_TC(const BDMA_TypeDef *BDMAx,
                                                uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_BDMA_IsEnabledIT_HT(const BDMA_TypeDef *BDMAx,
                                                uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
 ...
 * @retval State of bit (1 or 0).
 */
__STATIC_INLINE uint32_t LL_BDMA_IsEnabledIT_TE(const BDMA_TypeDef *BDMAx,
                                                uint32_t Channel) {
  uint32_t bdma_base_addr = (uint32_t)BDMAx;
...
uint32_t LL_BDMA_Init(BDMA_TypeDef *BDMAx, uint32_t Channel,
