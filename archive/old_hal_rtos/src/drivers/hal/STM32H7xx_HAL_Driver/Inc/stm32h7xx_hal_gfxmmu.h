...
typedef struct {
  ...
  uint32_t
      CacheLock;            /*!< Locking the cache to a buffer.
  ...
  uint32_t CacheLockBuffer; /*!< Buffer on which the cache is locked.
                               ...
                               enabled. */
  uint32_t
      CacheForce; /*!< Forcing the cache regardless MPU attributes.
                       This parameter can be a value of @ref GFXMMU_CacheForce.
                       @note: Useful only when lock of the cache is enabled. */
  uint32_t OutterBufferability; /*!< Bufferability of an access generated by the
                                   GFXMMU cache. This parameter can be a value
                                   of @ref GFXMMU_OutterBufferability. */
  uint32_t
  ...
  uint32_t
      Prefetch; /*!< Pre-fetch enable/disable.
...
typedef struct {
  ...
  uint32_t
      UsedInterrupts; /*!< Interrupts used.
...
#endif
{
  ...
  void (*MspDeInitCallback)(struct __GFXMMU_HandleTypeDef
...
typedef struct {
  ...
  int32_t LineOffset; /*!< Offset of block 0 of the current line in physical
                         ...
                         following formula: LineOffset = [(Blocks already used)
                         - (1st visible block)]*BlockSize. */
...
#define IS_GFXMMU_PREFETCH(VALUE)                                              \
  (((VALUE) == GFXMMU_PREFETCH_DISABLE) || ((VALUE) == GFXMMU_PREFETCH_ENABLE))
...
#define IS_GFXMMU_LUT_LINE_STATUS(VALUE)                                       \
  (((VALUE) == GFXMMU_LUT_LINE_DISABLE) || ((VALUE) == GFXMMU_LUT_LINE_ENABLE))
