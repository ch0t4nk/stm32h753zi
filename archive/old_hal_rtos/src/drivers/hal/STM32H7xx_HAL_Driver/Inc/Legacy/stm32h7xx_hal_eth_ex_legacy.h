...
HAL_StatusTypeDef
HAL_ETHEx_GetL3FilterConfig(ETH_HandleTypeDef *heth, uint32_t Filter,
                            ETH_L3FilterConfigTypeDef *pL3FilterConfig);
HAL_StatusTypeDef
HAL_ETHEx_GetL4FilterConfig(ETH_HandleTypeDef *heth, uint32_t Filter,
...
HAL_StatusTypeDef
HAL_ETHEx_GetRxVLANConfig(ETH_HandleTypeDef *heth,
...
HAL_StatusTypeDef
HAL_ETHEx_GetTxVLANConfig(ETH_HandleTypeDef *heth, uint32_t VLANTag,
