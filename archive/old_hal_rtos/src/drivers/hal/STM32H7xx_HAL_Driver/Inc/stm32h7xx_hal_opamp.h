...
#define OPAMP_NONINVERTINGINPUT_IO0                                            \
  0x00000000U /*!< OPAMP non-inverting input connected to dedicated IO pin */
...
#define OPAMP_NONINVERTINGINPUT_DAC2_CH                                        \
  OPAMP_CSR_VPSEL_1 /*!< Only OPAMP2 non-inverting input connected internally  \
                       to DAC2 channel */
#endif              /* DAC2 */
...
#define OPAMP_INVERTINGINPUT_IO1                                               \
  OPAMP_CSR_VMSEL_0 /*!< OPAMP inverting input connected to dedicated IO pin   \
                     */
...
#define OPAMP_PGA_CONNECT_INVERTINGINPUT_IO0                                   \
  OPAMP_CSR_PGGAIN_2 /*!< In PGA mode, the inverting input is connected to     \
                        VINM0 */
...
#define OPAMP_PGA_CONNECT_INVERTINGINPUT_IO0_IO1_BIAS                          \
  (OPAMP_CSR_PGGAIN_2 |                                                        \
   OPAMP_CSR_PGGAIN_3) /*!< In PGA mode, the inverting input is connected to   \
                          VINM0 or bias , VINM1 connected for filtering */
