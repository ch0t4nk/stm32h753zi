...
typedef struct {
  ...
  /* On devices STM32H72xx and STM32H73xx, this parameter can be a value from 1
   * to 1023 for ADC1/2 or a value of @ref ADC_HAL_EC_OVS_RATIO  for ADC3*/
#else
...
typedef struct {
...
#if defined(ADC_VER_V5_V90)
  uint32_t
      DataAlign; /*!< Specify ADC data alignment in conversion data register
                    (right or left). Refer to reference manual for alignments
                    formats versus resolutions. This parameter can be a value of
                    @ref ADC_HAL_EC_DATA_ALIGN This parameter is reserved for
  ...
  FunctionalState
      LowPowerAutoWait; /*!< Select the dynamic low power Auto Delay: new
                           ...
                           DMA transfers which can justify usage of auto wait).
                                           Do use with polling: 1. Start
                           conversion with HAL_ADC_Start(), 2. Later on, when
                           ADC conversion data is needed: and use
                           HAL_ADC_GetValue() to retrieve conversion result and
                           trig another conversion (in case of usage of injected
                           group, use the equivalent functions
  ...
  uint32_t
      ConversionDataManagement; /*!< Specifies whether the Data conversion data
                                  is managed: using the DMA (oneshot or
                                  circular), or stored in the DR register or
                                  transferred to DFSDM register. Note: In
                                  ...
                                  reached. This parameter can be a value of @ref
                                  ADC_ConversionDataManagement. Note: This
                                  parameter must be modified when no conversion
                                  is on going on both regular and injected
                                  groups (ADC disabled, or ADC enabled without
                                  continuous mode or external trigger that could
                                  launch a conversion).*/
#if defined(ADC_VER_V5_V90)
  /*Note: On devices STM32H72xx and STM32H73xx, this parameter is specific to
   * ADC3 only. */
  ...
  uint32_t SamplingMode; /*!< Select the sampling mode to be used for ADC group
                            ...
                            @ref ADC_regular_sampling_mode. Note:
                                   - On devices STM32H72xx and STM32H73xx, this
                            parameter is specific to ADC3 only. */
  ...
  uint32_t LeftBitShift; /*!< Configures the left shifting applied to the final
                            ...
                            can be a value of @ref ADCEx_Left_Bit_Shift */
  FunctionalState
...
typedef struct {
  ...
  uint32_t Offset; /*!< Define the offset to be subtracted from the raw
                      converted data. Offset value must be a positive number.
                        Maximum value depends on ADC resolution and oversampling
                      ratio (in case of oversampling used). This parameter must
                      be a number between Min_Data = 0x0000 and Max_Data =
                      0x3FFFC00 (corresponding to resolution 16 bit and
                      oversampling ratio 1024). Note: This parameter must be
                      modified when no conversion is on going on both regular
                      and injected groups (ADC disabled, or ADC enabled without
                      continuous mode or external trigger that could launch a
                      conversion). */

  FunctionalState
      OffsetRightShift; /*!< Define the Right-shift data after Offset
                          correction. This parameter is applied only for 16-bit
  ...
  uint32_t
      OffsetSign; /*!< Define if the offset should be subtracted (negative sign)
                    ...
                    Note:
                          - This parameter must be modified when no conversion
                    is on going on both regular and injected groups (ADC
                    disabled, or ADC enabled without continuous mode or external
                    trigger that could launch a conversion).
                          - Applicable for ADC3 on devices STM32H72xx and
                    STM32H73xx */
  FunctionalState
...
typedef struct {
  ...
  uint32_t
      HighThreshold; /*!< Configure the ADC analog watchdog High threshold
                        value. Depending of ADC resolution selected (16, 14, 12,
                        10, 8 bits), this parameter must be a number between
                        Min_Data = 0x000 and Max_Data = 0xFFFF, 0x3FFF, 0xFFF,
                        0x3FF or 0xFF respectively. Note: Analog watchdog 2 and
                        3 are limited to a resolution of 8 bits: if ADC
                        resolution is 12 bits the 4 LSB are ignored, if ADC
                        resolution is 10 bits the 2 LSB are ignored. Note: If
                        ADC oversampling is enabled, ADC analog watchdog
                        thresholds are impacted: the comparison of analog
                        watchdog thresholds is done on oversampling intermediate
                        computation (after ratio, before shift application):
                        intermediate register bitfield [32:7] (26 most
                        significant bits). */

  uint32_t
      LowThreshold; /*!< Configures the ADC analog watchdog Low threshold value.
                         Depending of ADC resolution selected (16, 14, 12, 10, 8
                       bits), this parameter must be a number between Min_Data =
                       0x000 and Max_Data = 0xFFFF, 0x3FFF, 0xFFF, 0x3FF or 0xFF
                       ...
                       before shift application): intermediate register bitfield
  ...
  uint32_t
      FilteringConfig; /*!< Specify whether filtering should be use and the
                          ...
                          parameter can be a value of @ref
                          ADC_analog_watchdog_filtering_config. Applicable for
                          ADC3 on devices STM32H72xx and STM32H73xx. */
#endif
...
#define ADC_RESOLUTION_16B                                                     \
  (LL_ADC_RESOLUTION_16B) /*!< ADC resolution 16 bits, On devices STM32H72xx   \
                             and STM32H73xx, parameter available only on ADC   \
                             instance: ADC1, ADC2 */
#define ADC_RESOLUTION_14B                                                     \
  (LL_ADC_RESOLUTION_14B) /*!< ADC resolution 14 bits, On devices STM32H72xx   \
                             and STM32H73xx, parameter available only on ADC   \
                             instance: ADC1, ADC2  */
...
#define ADC_RESOLUTION_14B_OPT                                                 \
  (LL_ADC_RESOLUTION_14B_OPT) /*!< ADC resolution 14 bits optimized for power  \
                                 consumption, available on for devices         \
                                 revision V only */
#define ADC_RESOLUTION_12B_OPT                                                 \
  (LL_ADC_RESOLUTION_12B_OPT) /*!< ADC resolution 12 bits optimized for power  \
                                 consumption, available on for devices         \
                                 revision V only */
#endif
...
#define ADC_RESOLUTION_6B                                                      \
  (LL_ADC_RESOLUTION_6B) /*!< ADC resolution  6 bits, On devices STM32H72xx    \
                            and STM32H73xx, parameter available only on ADC    \
                            instance: ADC3  */
...
#define ADC_EXTERNALTRIG_EXT_IT11                                              \
  (LL_ADC_REG_TRIG_EXT_EXTI_LINE11) /*!< ADC group regular conversion trigger  \
                                       ...
                                       interrupt line 11 event. Trigger edge   \
...
#define ADC_EXTERNALTRIG_HR1_ADCTRG3                                           \
  (LL_ADC_REG_TRIG_EXT_HRTIM_TRG3) /*!< ADC group regular conversion trigger   \
                                      from external peripheral: HRTIM TRG3     \
                                      event. Trigger edge set to rising edge   \
                                      (default setting). */
#define ADC_EXTERNALTRIG_LPTIM1_OUT                                            \
  (LL_ADC_REG_TRIG_EXT_LPTIM1_OUT) /*!< ADC group regular conversion trigger   \
                                      from external peripheral: LPTIM1 OUT     \
                                      event. Trigger edge set to rising edge   \
                                      (default setting). */
#define ADC_EXTERNALTRIG_LPTIM2_OUT                                            \
  (LL_ADC_REG_TRIG_EXT_LPTIM2_OUT) /*!< ADC group regular conversion trigger   \
                                      from external peripheral: LPTIM2 OUT     \
                                      event. Trigger edge set to rising edge   \
                                      (default setting). */
#define ADC_EXTERNALTRIG_LPTIM3_OUT                                            \
  (LL_ADC_REG_TRIG_EXT_LPTIM3_OUT) /*!< ADC group regular conversion trigger   \
                                      from external peripheral: LPTIM3 event   \
                                      OUT. Trigger edge set to rising edge     \
                                      (default setting). */
#if defined(TIM23)
#define ADC_EXTERNALTRIG_T23_TRGO                                              \
  (LL_ADC_REG_TRIG_EXT_TIM23_TRGO) /*!< ADC group regular conversion trigger   \
                                      from external peripheral: TIM23 TRGO     \
                                      event. Trigger edge set to rising edge   \
                                      (default setting). */
#endif                             /*TIM23*/
#if defined(TIM24)
#define ADC_EXTERNALTRIG_T24_TRGO                                              \
  (LL_ADC_REG_TRIG_EXT_TIM24_TRGO) /*!< ADC group regular conversion trigger   \
...
#define ADC_SAMPLING_MODE_BULB                                                 \
  (ADC3_CFGR2_BULB) /*!< ADC conversions sampling phase starts immediately     \
                       after end of conversion, and stops upon trigger event.  \
                               Notes:                                          \
                                     - First conversion is using minimal       \
                       sampling time (see @ref                                 \
                       ADC_HAL_EC_CHANNEL_SAMPLINGTIME)                        \
                                     - Applicable for ADC3 on devices          \
...
#define ADC_SAMPLING_MODE_TRIGGER_CONTROLED                                    \
  (ADC3_CFGR2_SMPTRIG) /*!< ADC conversions sampling phase is controlled by    \
                          ...
                          start conversion Note: Applicable for ADC3 on        \
...
#define ADC_SAMPLETIME_1CYCLE_5                                                \
  (LL_ADC_SAMPLINGTIME_1CYCLE_5) /*!< Sampling time 1.5 ADC clock cycles, On   \
                                    devices STM32H72xx and STM32H73xx,         \
                                    parameter available only on ADC instance:  \
                                    ADC1, ADC2 */
#define ADC_SAMPLETIME_2CYCLES_5                                               \
  (LL_ADC_SAMPLINGTIME_2CYCLES_5) /*!< Sampling time 2.5 ADC clock cycles, On  \
                                     devices STM32H72xx and STM32H73xx,        \
                                     parameter available only on ADC instance: \
                                     ADC1, ADC2 */
#define ADC_SAMPLETIME_8CYCLES_5                                               \
  (LL_ADC_SAMPLINGTIME_8CYCLES_5) /*!< Sampling time 8.5 ADC clock cycles, On  \
                                     devices STM32H72xx and STM32H73xx,        \
                                     parameter available only on ADC instance: \
                                     ADC1, ADC2 */
#define ADC_SAMPLETIME_16CYCLES_5                                              \
  (LL_ADC_SAMPLINGTIME_16CYCLES_5) /*!< Sampling time 16.5 ADC clock cycles,   \
                                      On devices STM32H72xx and STM32H73xx,    \
                                      parameter available only on ADC          \
                                      instance: ADC1, ADC2 */
 ...
 * @{
 */
#define ADC3_SAMPLETIME_2CYCLES_5                                              \
  (LL_ADC_SAMPLINGTIME_ADC3_2CYCLES_5) /*!< Sampling time 2.5 ADC clock        \
                                          cycles, On devices STM32H72xx and    \
                                          STM32H73xx, parameter available only \
                                          on ADC instance: ADC3 */
#define ADC3_SAMPLETIME_6CYCLES_5                                              \
  (LL_ADC_SAMPLINGTIME_ADC3_6CYCLES_5) /*!< Sampling time 6.5 ADC clock        \
                                          cycles, On devices STM32H72xx and    \
                                          STM32H73xx, parameter available only \
                                          on ADC instance: ADC3 */
#define ADC3_SAMPLETIME_12CYCLES_5                                             \
  (LL_ADC_SAMPLINGTIME_ADC3_12CYCLES_5) /*!< Sampling time 12.5 ADC clock      \
                                           cycles, On devices STM32H72xx and   \
                                           STM32H73xx, parameter available     \
                                           only on ADC instance: ADC3 */
#define ADC3_SAMPLETIME_24CYCLES_5                                             \
  (LL_ADC_SAMPLINGTIME_ADC3_24CYCLES_5) /*!< Sampling time 24.5 ADC clock      \
                                           cycles, On devices STM32H72xx and   \
                                           STM32H73xx, parameter available     \
                                           only on ADC instance: ADC3 */
#define ADC3_SAMPLETIME_47CYCLES_5                                             \
  (LL_ADC_SAMPLINGTIME_ADC3_47CYCLES_5) /*!< Sampling time 47.5 ADC clock      \
                                           cycles, On devices STM32H72xx and   \
                                           STM32H73xx, parameter available     \
                                           only on ADC instance: ADC3 */
#define ADC3_SAMPLETIME_92CYCLES_5                                             \
  (LL_ADC_SAMPLINGTIME_ADC3_92CYCLES_5) /*!< Sampling time 92.5 ADC clock      \
                                           cycles, On devices STM32H72xx and   \
                                           STM32H73xx, parameter available     \
                                           only on ADC instance: ADC3 */
#define ADC3_SAMPLETIME_247CYCLES_5                                            \
  (LL_ADC_SAMPLINGTIME_ADC3_247CYCLES_5) /*!< Sampling time 247.5 ADC clock    \
                                            cycles, On devices STM32H72xx and  \
                                            STM32H73xx, parameter available    \
                                            only on ADC instance: ADC3 */
#define ADC3_SAMPLETIME_640CYCLES_5                                            \
  (LL_ADC_SAMPLINGTIME_ADC3_640CYCLES_5) /*!< Sampling time 640.5 ADC clock    \
                                            cycles, On devices STM32H72xx and  \
                                            STM32H73xx, parameter available    \
                                            only on ADC instance: ADC3 */
#define ADC3_SAMPLETIME_3CYCLES_5                                              \
  (ADC_SMPR1_SMPPLUS |                                                         \
   LL_ADC_SAMPLINGTIME_ADC3_2CYCLES_5) /*!< Sampling time 3.5 ADC clock        \
                                          cycles. If selected, this sampling   \
                                          time replaces all sampling time 2.5  \
                                          ADC clock cycles. These 2 sampling   \
                                          times cannot be used simultaneously. \
                                            On devices STM32H72xx and          \
                                          STM32H73xx, parameter available only \
                                          on ADC instance: ADC3 */
/**
 * @}
...
#define ADC_CHANNEL_VREFINT                                                    \
  (LL_ADC_CHANNEL_VREFINT) /*!< ADC internal channel connected to VrefInt:     \
                              Internal voltage reference, channel specific to  \
                              ADC3. */
#define ADC_CHANNEL_TEMPSENSOR                                                 \
  (LL_ADC_CHANNEL_TEMPSENSOR) /*!< ADC internal channel connected to           \
                                 Temperature sensor, channel specific to ADC3. \
                               */
#define ADC_CHANNEL_VBAT                                                       \
  (LL_ADC_CHANNEL_VBAT) /*!< ADC internal channel connected to Vbat/4: Vbat    \
                           voltage through a divider ladder of factor 1/4 to   \
                           have Vbat always below Vdda, channel specific to    \
                           ADC3. */
#define ADC_CHANNEL_DAC1CH1_ADC2                                               \
  (LL_ADC_CHANNEL_DAC1CH1_ADC2) /*!< ADC internal channel connected to DAC1    \
                                   channel 1, channel specific to ADC2 */
#define ADC_CHANNEL_DAC1CH2_ADC2                                               \
  (LL_ADC_CHANNEL_DAC1CH2_ADC2) /*!< ADC internal channel connected to DAC1    \
                                   channel 2, channel specific to ADC2 */
#if defined(LL_ADC_CHANNEL_DAC2CH1_ADC2)
#define ADC_CHANNEL_DAC2CH1_ADC2                                               \
  (LL_ADC_CHANNEL_DAC2CH1_ADC2) /*!< ADC internal channel connected to DAC2    \
                                   channel 1, channel specific to ADC2 */
#endif
/**
 * @}
...
#define ADC_CONVERSIONDATA_DR                                                  \
  ((uint32_t)0x00000000) /*!< Regular Conversion data stored in DR register    \
                            only  */
 ...
 * @{
 */
#define ADC3_AWD_FILTERING_NONE                                                \
  (0x00000000UL) /*!< ADC analog watchdog no filtering, one out-of-window      \
                    sample is needed to raise flag or interrupt. Applicable    \
                    for ADC3 on devices STM32H72xx and STM32H73xx */
...
#define ADC3_AWD_FILTERING_3SAMPLES                                            \
  ((ADC3_TR1_AWDFILT_1)) /*!< ADC analog watchdog 3 consecutives out-of-window \
                            ...
                            Applicable for ADC3 on devices STM32H72xx and      \
                            STM32H73xx */
#define ADC3_AWD_FILTERING_4SAMPLES                                            \
  ((ADC3_TR1_AWDFILT_1 |                                                       \
...
#define ADC3_AWD_FILTERING_5SAMPLES                                            \
  ((ADC3_TR1_AWDFILT_2)) /*!< ADC analog watchdog 5 consecutives out-of-window \
                            ...
                            Applicable for ADC3 on devices STM32H72xx and      \
                            STM32H73xx */
#define ADC3_AWD_FILTERING_6SAMPLES                                            \
  ((ADC3_TR1_AWDFILT_2 |                                                       \
...
#define ADC3_AWD_FILTERING_7SAMPLES                                            \
  ((ADC3_TR1_AWDFILT_2 |                                                       \
    ADC3_TR1_AWDFILT_1)) /*!< ADC analog watchdog 7 consecutives out-of-window \
                            ...
                            Applicable for ADC3 on devices STM32H72xx and      \
                            STM32H73xx */
#define ADC3_AWD_FILTERING_8SAMPLES                                            \
 ...
 * @{
 */
#define ADC3_OVERSAMPLING_RATIO_2                                              \
  (LL_ADC_OVS_RATIO_2) /*!< ADC oversampling ratio of 2 (2 ADC conversions are \
                          ...
                          (before potential shift). Applicable for ADC3 on     \
                          devices STM32H72xx and STM32H73xx */
#define ADC3_OVERSAMPLING_RATIO_4                                              \
  (LL_ADC_OVS_RATIO_4) /*!< ADC oversampling ratio of 4 (4 ADC conversions are \
                          performed, sum of these conversions data is computed \
                          to result as the ADC oversampling conversion data    \
                          (before potential shift). Applicable for ADC3 on     \
                          devices STM32H72xx and STM32H73xx */
#define ADC3_OVERSAMPLING_RATIO_8                                              \
  (LL_ADC_OVS_RATIO_8) /*!< ADC oversampling ratio of 8 (8 ADC conversions are \
                          performed, sum of these conversions data is computed \
                          to result as the ADC oversampling conversion data    \
                          (before potential shift). Applicable for ADC3 on     \
                          devices STM32H72xx and STM32H73xx */
#define ADC3_OVERSAMPLING_RATIO_16                                             \
...
#define ADC3_OVERSAMPLING_RATIO_32                                             \
  (LL_ADC_OVS_RATIO_32) /*!< ADC oversampling ratio of 32 (32 ADC conversions  \
                           ...
                           Applicable for ADC3 on devices STM32H72xx and       \
                           STM32H73xx */
#define ADC3_OVERSAMPLING_RATIO_64                                             \
  (LL_ADC_OVS_RATIO_64) /*!< ADC oversampling ratio of 64 (64 ADC conversions  \
                           ...
                           Applicable for ADC3 on devices STM32H72xx and       \
                           STM32H73xx */
#define ADC3_OVERSAMPLING_RATIO_128                                            \
  (LL_ADC_OVS_RATIO_128) /*!< ADC oversampling ratio of 128 (128 ADC           \
                            ...
                            shift). Applicable for ADC3 on devices STM32H72xx  \
                            and STM32H73xx */
#define ADC3_OVERSAMPLING_RATIO_256                                            \
  (LL_ADC_OVS_RATIO_256) /*!< ADC oversampling ratio of 256 (256 ADC           \
                            ...
                            shift). Applicable for ADC3 on devices STM32H72xx  \
                            and STM32H73xx */
#define ADC3_OVERSAMPLING_RATIO_512                                            \
  (LL_ADC_OVS_RATIO_512) /*!< ADC oversampling ratio of 256 (256 ADC           \
                            ...
                            shift). Applicable for ADC3 on devices STM32H72xx  \
                            and STM32H73xx */
#define ADC3_OVERSAMPLING_RATIO_1024                                           \
...
#define ADC_RIGHTBITSHIFT_9                                                    \
  (LL_ADC_OVS_SHIFT_RIGHT_9) /*!< ADC oversampling shift of 9 (sum of the ADC  \
                                conversions data is divided by 512 to result   \
                                as the ADC oversampling conversion data) */
#define ADC_RIGHTBITSHIFT_10                                                   \
  (LL_ADC_OVS_SHIFT_RIGHT_10) /*!< ADC oversampling shift of 10 (sum of the    \
                                 ADC conversions data is divided by 1024 to    \
                                 result as the ADC oversampling conversion     \
                                 data) */
#define ADC_RIGHTBITSHIFT_11                                                   \
  (LL_ADC_OVS_SHIFT_RIGHT_11) /*!< ADC oversampling shift of 11 (sum of the    \
...
#define ADC_FLAG_LDORDY                                                        \
  ADC_ISR_LDORDY /*!< ADC LDO output voltage ready bit                         \
                  */
/**
 * @}
 */
...
#if defined(ADC_VER_V5_V90)
/**
 * @brief Verify the ADC converted data alignment. Applicable for ADC3 on
 * devices STM32H72xx and STM32H73xx.
