...
typedef struct {
  uint32_t
      ColorSpace; /*!< Image Color space : gray-scale, YCBCR, RGB or CMYK
  ...
  uint32_t ChromaSubsampling; /*!< Chroma Subsampling in case of YCBCR or CMYK
                                 color space, 0-> 4:4:4 , 1-> 4:2:2, 2 -> 4:1:1,
                                 3 -> 4:2:0 This parameter can be a value of
...
#define JPEG_FLAG_IFNFF                                                        \
  ((uint32_t)                                                                  \
       JPEG_SR_IFNFF) /*!< Input FIFO Not Full Flag, a data can be written */
#define JPEG_FLAG_OFTF                                                         \
  ((uint32_t)JPEG_SR_OFTF) /*!< Output FIFO is not empty and has reach its     \
                              threshold */
#define JPEG_FLAG_OFNEF                                                        \
  ((uint32_t)                                                                  \
       JPEG_SR_OFNEF) /*!< Output FIFO is not empty, a data is available  */
...
#define JPEG_FLAG_HPDF                                                         \
  ((uint32_t)                                                                  \
       JPEG_SR_HPDF) /*!< JPEG Codec has finished the parsing of the headers   \
