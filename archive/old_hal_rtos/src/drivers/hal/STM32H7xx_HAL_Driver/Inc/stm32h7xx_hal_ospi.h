...
typedef struct {
  ...
  uint32_t ChipSelectHighTime; /*!< It defines the minimum number of clocks
                                  which the chip select must remain high between
          ...
          (USE_HAL_OSPI_REGISTER_CALLBACKS == 1U) */
{
  ...
  MDMA_HandleTypeDef
      *hmdma;          /*!< Handle of the MDMA channel used for the transfer  */
...
typedef struct {
  ...
  uint32_t FlashId; /*!< It indicates which external device is selected for this
                       ...
                       initialization structure). This parameter can be a value
                       of @ref OSPI_FlashID */
...
typedef struct {
  ...
  uint32_t
      AccessTime; /*!< It indicates the number of cycles for the device access
...
typedef struct {
  uint32_t AddressSpace; /*!< It indicates the address space accessed by the
                            ...
                            OSPI_AddressSpace */
  uint32_t
      Address;          /*!< It contains the address to be sent tot he device.
                             This parameter can be a value between 0 and 0xFFFFFFFF */
  uint32_t AddressSize; /*!< It indicates the size of the address.
                             This parameter can be a value of @ref
                           OSPI_AddressSize */
  uint32_t NbData;  /*!< It indicates the number of data transferred with this
                       command.  This field is only used for indirect mode.  This
                       parameter can be a value between 1 and 0xFFFFFFFF  In case
                       of autopolling mode, this parameter can be any value
                       between 1 and 4 */
  uint32_t DQSMode; /*!< It enables or not the data strobe management.
                         This parameter can be a value of @ref OSPI_DQSMode */
...
typedef struct {
  ...
  uint32_t
      TimeOutPeriod; /*!< Specifies the number of clock to wait when the FIFO is
                        full before to release the chip select. This parameter
                        can be any value between 0 and 0xFFFF */
...
typedef struct {
  uint32_t
      ClkPort; /*!< It indicates which port of the OSPI IO Manager is used for
                  the CLK pins. This parameter can be a value between 1 and 8 */
  uint32_t DQSPort; /*!< It indicates which port of the OSPI IO Manager is used
                       for the DQS pin. This parameter can be a value between 0
                       and 8, 0 means that signal not used */
  uint32_t
      NCSPort; /*!< It indicates which port of the OSPI IO Manager is used for
                  the NCS pin. This parameter can be a value between 1 and 8 */
  ...
  uint32_t IOHighPort; /*!< It indicates which port of the OSPI IO Manager is
                          ...
                          value of @ref OSPIM_IOPort */
  uint32_t
      Req2AckTime; /*!< It indicates the minimum switching duration (in number
                      of clock cycles) expected if some signals are multiplexed
                      in the OSPI IO Manager with the other OSPI. This parameter
                      can be a value between 1 and 256 */
} OSPIM_CfgTypeDef;
...
#define HAL_OSPI_STATE_CMD_CFG                                                 \
  ((uint32_t)0x00000004U) /*!< Command (regular or hyperbus) configured, ready \
                             for an action          */
#define HAL_OSPI_STATE_READ_CMD_CFG                                            \
  ((uint32_t)0x00000014U) /*!< Read command configuration done, not the write  \
                             command configuration   */
#define HAL_OSPI_STATE_WRITE_CMD_CFG                                           \
  ((uint32_t)0x00000024U) /*!< Write command configuration done, not the read  \
                             command configuration   */
...
#define HAL_OSPI_ERROR_INVALID_SEQUENCE                                        \
  ((uint32_t)0x00000010U) /*!< Sequence of the state machine is incorrect */
#if defined(USE_HAL_OSPI_REGISTER_CALLBACKS) &&                                \
    (USE_HAL_OSPI_REGISTER_CALLBACKS == 1U)
...
#define HAL_OSPI_FREERUNCLK_ENABLE                                             \
  ((uint32_t)OCTOSPI_DCR1_FRCK) /*!< CLK is free running (always provided) */
/**
 * @}
 */
...
#define HAL_OSPI_CLOCK_MODE_3                                                  \
  ((uint32_t)OCTOSPI_DCR1_CKMODE) /*!< CLK must stay high while nCS is high */
/**
 * @}
 */
...
#define HAL_OSPI_WRAP_16_BYTES                                                 \
  ((uint32_t)OCTOSPI_DCR2_WRAPSIZE_1) /*!< external memory supports wrap size  \
                                         of 16 bytes  */
#define HAL_OSPI_WRAP_32_BYTES                                                 \
  ((uint32_t)(OCTOSPI_DCR2_WRAPSIZE_0 |                                        \
              OCTOSPI_DCR2_WRAPSIZE_1)) /*!< external memory supports wrap     \
                                           size of 32 bytes  */
#define HAL_OSPI_WRAP_64_BYTES                                                 \
  ((uint32_t)OCTOSPI_DCR2_WRAPSIZE_2) /*!< external memory supports wrap size  \
                                         of 64 bytes  */
#define HAL_OSPI_WRAP_128_BYTES                                                \
  ((uint32_t)(OCTOSPI_DCR2_WRAPSIZE_0 |                                        \
              OCTOSPI_DCR2_WRAPSIZE_2)) /*!< external memory supports wrap     \
                                           size of 128 bytes */
/**
 * @}
 */
...
#define HAL_OSPI_OPTYPE_COMMON_CFG                                             \
  ((uint32_t)0x00000000U) /*!< Common configuration (indirect or auto-polling  \
                             mode) */
...
#define HAL_OSPI_ALTERNATE_BYTES_DTR_ENABLE                                    \
  ((uint32_t)                                                                  \
       OCTOSPI_CCR_ABDTR) /*!< DTR mode enabled for alternate bytes phase  */
/**
 * @}
 */
...
#define HAL_OSPI_SIOO_INST_ONLY_FIRST_CMD                                      \
  ((uint32_t)                                                                  \
       OCTOSPI_CCR_SIOO) /*!< Send instruction only for the first command */
/**
 * @}
 */
...
#define HAL_OSPI_AUTOMATIC_STOP_ENABLE                                         \
  ((uint32_t)                                                                  \
       OCTOSPI_CR_APMS) /*!< AutoPolling stops as soon as there is a match */
/**
 * @}
 */
...
#define HAL_OSPI_FLAG_SM                                                       \
  OCTOSPI_SR_SMF /*!< Status match flag: received data matches in autopolling  \
                    mode                                             */
#define HAL_OSPI_FLAG_FT                                                       \
  OCTOSPI_SR_FTF /*!< Fifo threshold flag: Fifo threshold reached or data left \
                    after read from memory is complete              */
#define HAL_OSPI_FLAG_TC                                                       \
  OCTOSPI_SR_TCF /*!< Transfer complete flag: programmed number of data have   \
...
#define IS_OSPI_WRAP_SIZE(SIZE)                                                \
  (((SIZE) == HAL_OSPI_WRAP_NOT_SUPPORTED) ||                                  \
   ((SIZE) == HAL_OSPI_WRAP_16_BYTES) || ((SIZE) == HAL_OSPI_WRAP_32_BYTES) || \
   ((SIZE) == HAL_OSPI_WRAP_64_BYTES) || ((SIZE) == HAL_OSPI_WRAP_128_BYTES))
...
#define IS_OSPI_DHQC(CYCLE)                                                    \
  (((CYCLE) == HAL_OSPI_DHQC_DISABLE) || ((CYCLE) == HAL_OSPI_DHQC_ENABLE))
...
#define IS_OSPI_FLASH_ID(FLASHID)                                              \
  (((FLASHID) == HAL_OSPI_FLASH_ID_1) || ((FLASHID) == HAL_OSPI_FLASH_ID_2))
...
#define IS_OSPI_DATA_MODE(MODE)                                                \
  (((MODE) == HAL_OSPI_DATA_NONE) || ((MODE) == HAL_OSPI_DATA_1_LINE) ||       \
   ((MODE) == HAL_OSPI_DATA_2_LINES) || ((MODE) == HAL_OSPI_DATA_4_LINES) ||   \
...
#define IS_OSPI_LATENCY_MODE(MODE)                                             \
  (((MODE) == HAL_OSPI_VARIABLE_LATENCY) || ((MODE) == HAL_OSPI_FIXED_LATENCY))
...
#define IS_OSPI_MATCH_MODE(MODE)                                               \
  (((MODE) == HAL_OSPI_MATCH_MODE_AND) || ((MODE) == HAL_OSPI_MATCH_MODE_OR))
