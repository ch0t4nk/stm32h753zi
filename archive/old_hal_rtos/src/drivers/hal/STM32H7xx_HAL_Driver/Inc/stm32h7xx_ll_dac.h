 ...
 * datasheet for supported features list) (2) On this STM32 series, parameter
 * only available on DAC2. (3) On this STM32 series, parameter not available on
 * all devices. Only available if TIM23 feature is supported (refer to device
 * datasheet for supported features list) (4) On this STM32 series, parameter
 * not available on all devices. Only available if TIM24 feature is supported
 * (refer to device datasheet for supported features list)
 * @retval None
 */
