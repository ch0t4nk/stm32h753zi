...
// ================================================================================================
// CONFIGURATION AND CONSTANTS (SSOT)
// ================================================================================================

#include "config/telemetry_config.h" // SSOT: All telemetry config here
// TODO: See .github/instructions/ssot-config.instructions.md for SSOT policy

#define CHARACTERIZATION_BUFFER_SIZE TELEMETRY_CHARACTERIZATION_BUFFER_SIZE
