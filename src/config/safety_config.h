...
#define ENCODER_ANGLE_JUMP_THRESHOLD_DEG 30.0f  // Maximum single-sample angle change
#define ENCODER_NOISE_THRESHOLD_DEG     0.1f    // Noise level threshold
#define ENCODER_STUCK_TIME_MS           5000    // Time without change to detect stuck encoder
...
#define ENCODER_MOTOR_DEVIATION_MAX_DEG 2.0f    // Maximum deviation between encoder and steps
...
#define CAN_BUS_OFF_RECOVERY_TIME_MS    30000   // Time before bus-off recovery attempt
