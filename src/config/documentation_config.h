 ...
 * @brief Documentation Structure Configuration - SSOT for Documentation Management
 * 
 ...
 * 
 * Related Files:
 * - .github/instructions/ssot-config.instructions.md - SSOT architecture guidance
...
#define INSTRUCTION_ERROR_HANDLING      ".github/instructions/error-handling.instructions.md"
#define INSTRUCTION_BUILD_CONFIG        ".github/instructions/build-config.instructions.md"

/* Hardware Configuration Instructions */
#define INSTRUCTION_HARDWARE_PINS       ".github/instructions/hardware-pins.instructions.md"
#define INSTRUCTION_HARDWARE_VARIANTS   ".github/instructions/hardware-variants.instructions.md"
#define INSTRUCTION_MEMORY_CONFIG       ".github/instructions/memory-config.instructions.md"

/* Motor Control Instructions */
#define INSTRUCTION_L6470_REGISTERS     ".github/instructions/l6470-registers.instructions.md"
#define INSTRUCTION_SAFETY_SYSTEMS      ".github/instructions/safety-systems.instructions.md"
#define INSTRUCTION_TIME_HANDLING       ".github/instructions/time-handling.instructions.md"
#define INSTRUCTION_UNITS_MEASUREMENTS  ".github/instructions/units-measurements.instructions.md"
#define INSTRUCTION_CONTROL_TIMING      ".github/instructions/control-timing.instructions.md"

/* Communication Instructions */
#define INSTRUCTION_COMM_PROTOCOLS      ".github/instructions/comm-protocols.instructions.md"
#define INSTRUCTION_STM32H7_UART        ".github/instructions/stm32h7-uart-protocol.instructions.md"
#define INSTRUCTION_STM32H7_SPI_L6470   ".github/instructions/stm32h7-spi-l6470.instructions.md"
#define INSTRUCTION_STM32H7_I2C_AS5600  ".github/instructions/stm32h7-i2c-as5600.instructions.md"
#define INSTRUCTION_STM32H7_GPIO_HAL    ".github/instructions/stm32h7-gpio-hal.instructions.md"

/* Development Process Instructions */
#define INSTRUCTION_BUILD_VALIDATION    ".github/instructions/build-validation.instructions.md"
#define INSTRUCTION_BUILD_VERSION       ".github/instructions/build-version.instructions.md"
#define INSTRUCTION_TESTING_CONFIG      ".github/instructions/testing-config.instructions.md"
#define INSTRUCTION_DEBUG_CONFIG        ".github/instructions/debug-config.instructions.md"
#define INSTRUCTION_OPTIMIZATION        ".github/instructions/optimization.instructions.md"

/* System Architecture Instructions */
#define INSTRUCTION_STATE_MANAGEMENT    ".github/instructions/state-management.instructions.md"
#define INSTRUCTION_STATE_ACCESS        ".github/instructions/state-access.instructions.md"
#define INSTRUCTION_SYSTEM_STATE        ".github/instructions/system-state.instructions.md"
#define INSTRUCTION_THREAD_SAFETY       ".github/instructions/thread-safety.instructions.md"
#define INSTRUCTION_BUFFER_MANAGEMENT   ".github/instructions/buffer-management.instructions.md"

/* Advanced Topics Instructions */
#define INSTRUCTION_FEATURE_FLAGS       ".github/instructions/feature-flags.instructions.md"
#define INSTRUCTION_PORTABILITY         ".github/instructions/portability.instructions.md"
#define INSTRUCTION_USER_INTERFACE      ".github/instructions/user-interface.instructions.md"
...
#define CONSOLIDATION_SCRIPT_PATH       "scripts/consolidate_instruction_references.py"
...
/* TODO: See .github/instructions/ssot-config.instructions.md for SSOT architecture guidance */
/* TODO: See .github/instructions/workspace-setup.instructions.md for complete project overview */
