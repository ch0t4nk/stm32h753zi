...
/* ========================================================================== */
// TODO: See .instructions/build-version.md for automatic version generation from git
...
#define VERSION_STRING          "v" STRINGIFY(VERSION_MAJOR) "." \
                               STRINGIFY(VERSION_MINOR) "." \
                               STRINGIFY(VERSION_PATCH) "-build" \
