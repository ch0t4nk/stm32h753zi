...
/* ==========================================================================
 */
/* Essential System Definitions (HAL Compatibility)                          */
/* ==========================================================================
 */

/* Ensure critical HAL symbols are available */
#ifndef assert_param
...
/* Ensure oscillator values are defined */
#ifndef CSI_VALUE
...
/* Essential Flash Bank Constants (if missing from headers) */
#ifndef FLASH_BANK_1
...
/* ==========================================================================
 */
// TODO: See .instructions/feature-flags.md for conditional compilation
// strategy
