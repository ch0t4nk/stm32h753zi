...
/* ========================================================================== */
// TODO: See .github/instructions/error-handling.instructions.md for motor fault
// handling
...
/* ========================================================================== */
// TODO: See .github/instructions/error-handling.instructions.md for encoder
// fault detection
...
typedef enum {
  ...
  ERROR_CAN_INIT_FAILED =
      ERROR_CODE_COMM_BASE + 0x10, // 0x4010 - CAN initialization failed
  ...
  ERROR_ETH_INIT_FAILED =
      ERROR_CODE_COMM_BASE + 0x20, // 0x4020 - Ethernet initialization failed
  ...
  ERROR_I2C_INIT_FAILED =
      ERROR_CODE_COMM_BASE + 0x30, // 0x4030 - I2C initialization failed
  ...
  ERROR_SPI_INIT_FAILED =
      ERROR_CODE_COMM_BASE + 0x40, // 0x4040 - SPI initialization failed
...
typedef enum {
  ...
  ERROR_SAFETY_INIT_FAILED =
      ERROR_CODE_SAFETY_BASE,    // 0x5000 - Safety system init failed
...
/* ========================================================================== */
// TODO: See .github/instructions/error-handling.instructions.md for system
// error handling

typedef enum {
  // Hardware errors
  ERROR_HARDWARE_FAILURE =
      ERROR_CODE_SYSTEM_BASE, // 0x6000 - General hardware failure
...
typedef enum {
  ERROR_CONFIG_INVALID =
      ERROR_CODE_CONFIG_BASE,     // 0x7000 - Invalid configuration
...
typedef enum {
  ERROR_TEST_FRAMEWORK_FAILED =
      ERROR_CODE_TEST_BASE,     // 0x8000 - Test framework failure
