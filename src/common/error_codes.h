...
typedef enum {
  ...
  ERROR_MOTOR_SEQUENCE_ERROR,                      // 0x201A - Motor sequence error
  ...
  ERROR_ENCODER_CORRELATION_FAILED,                    // 0x300C - Encoder-motor correlation failed
  ...
  ERROR_ENCODER_LINEARIZATION_FAILED,                  // 0x3019 - Encoder linearization failed
