 ...
 *       must reference this single instance - never duplicate state information.
 * 
...
typedef struct {
    ...
    void (*observers[MAX_STATE_OBSERVERS])(void); // State change observer callbacks
 ...
 * @return SystemError_t Error code or SYSTEM_OK
 */
SystemError_t system_state_set_motor_target_angle(uint8_t motor_id, float angle_deg);
 ...
 * @return SystemError_t Error code or SYSTEM_OK
 */
SystemError_t system_state_get_motor_current_angle(uint8_t motor_id, float* angle_deg);
 ...
 * @return SystemError_t Error code or SYSTEM_OK
 */
SystemError_t system_state_set_motor_fault_flags(uint8_t motor_id, MotorFaultFlags_t fault_flags);
 ...
 * @return SystemError_t Error code or SYSTEM_OK
 */
SystemError_t system_state_clear_motor_fault_flags(uint8_t motor_id, MotorFaultFlags_t fault_flags);
 ...
 * @return SystemError_t Error code or SYSTEM_OK
 */
SystemError_t system_state_set_encoder_raw_angle(uint8_t encoder_id, uint16_t raw_value);
 ...
 * @return SystemError_t Error code or SYSTEM_OK
 */
SystemError_t system_state_get_encoder_angle(uint8_t encoder_id, float* angle_deg);
 ...
 * @return SystemError_t Error code or SYSTEM_OK
 */
SystemError_t system_state_set_encoder_comm_status(uint8_t encoder_id, bool communication_ok);
 ...
 * @return SystemError_t Error code or SYSTEM_OK
 */
SystemError_t system_state_set_safety_fault_flags(SafetyFaultFlags_t fault_flags);
 ...
 * @return SystemError_t Error code or SYSTEM_OK
 */
SystemError_t system_state_clear_safety_fault_flags(SafetyFaultFlags_t fault_flags);
 ...
 * @return SystemError_t Error code or SYSTEM_OK
 */
SystemError_t system_state_update_memory_usage(uint32_t heap_used_bytes, uint32_t stack_used_bytes);
