 ...
 *          This file provides system initialization template functions is case
 *of an application using a dual core STM32H7 device where : Cortex-M7 boot is
 *enabled at FLASH option bytes Cortex-M4 boot is disabled at FLASH option bytes
