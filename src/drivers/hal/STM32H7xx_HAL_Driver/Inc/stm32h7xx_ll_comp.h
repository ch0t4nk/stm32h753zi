...
#define LL_COMP_WINDOWMODE_COMP1_INPUT_PLUS_COMMON                             \
  (COMP_CFGRx_WINMODE) /*!< Window mode enable: Comparators instances pair     \
...
#define LL_COMP_INPUT_PLUS_IO1                                                 \
  (0x00000000UL) /*!< Comparator input plus connected to IO1 (pin PB0 for      \
                    COMP1, pin PE9 for COMP2) */
#define LL_COMP_INPUT_PLUS_IO2                                                 \
  (COMP_CFGRx_INPSEL) /*!< Comparator input plus connected to IO2 (pin PB2 for \
                         COMP1, pin PE11 for COMP2) */
#if defined(COMP_CFGRx_INP2SEL)
#define LL_COMP_INPUT_PLUS_DAC2_CH1                                            \
  (COMP_CFGRx_INP2SEL) /*!< Comparator input plus 2 connected to (DAC2_CH1 for \
                          COMP1)                      */
#endif
/**
 * @}
...
#define LL_COMP_INPUT_MINUS_1_4VREFINT                                         \
  (COMP_CFGRx_SCALEN |                                                         \
   COMP_CFGRx_BRGEN) /*!< Comparator input minus connected to 1/4 VrefInt  */
#define LL_COMP_INPUT_MINUS_1_2VREFINT                                         \
  (COMP_CFGRx_INMSEL_0 | COMP_CFGRx_SCALEN |                                   \
   COMP_CFGRx_BRGEN) /*!< Comparator input minus connected to 1/2 VrefInt  */
#define LL_COMP_INPUT_MINUS_3_4VREFINT                                         \
  (COMP_CFGRx_INMSEL_1 | COMP_CFGRx_SCALEN |                                   \
   COMP_CFGRx_BRGEN) /*!< Comparator input minus connected to 3/4 VrefInt  */
...
#define LL_COMP_INPUT_MINUS_DAC1_CH1                                           \
  (COMP_CFGRx_INMSEL_2) /*!< Comparator input minus connected to DAC1 channel  \
                           1 (DAC_OUT1)  */
#define LL_COMP_INPUT_MINUS_DAC1_CH2                                           \
  (COMP_CFGRx_INMSEL_2 |                                                       \
   COMP_CFGRx_INMSEL_0) /*!< Comparator input minus connected to DAC1 channel  \
                           2 (DAC_OUT2)  */
#define LL_COMP_INPUT_MINUS_IO1                                                \
  (COMP_CFGRx_INMSEL_2 |                                                       \
   COMP_CFGRx_INMSEL_1) /*!< Comparator input minus connected to IO1 (pin PB1  \
                           for COMP1, pin PE10 for COMP2) */
#define LL_COMP_INPUT_MINUS_IO2                                                \
  (COMP_CFGRx_INMSEL_2 | COMP_CFGRx_INMSEL_1 |                                 \
   COMP_CFGRx_INMSEL_0) /*!< Comparator input minus connected to IO2 (pin PC4  \
                           for COMP1, pin PE7 for COMP2) */
#if defined(COMP_CFGRx_INMSEL_3)
#define LL_COMP_INPUT_MINUS_TPSENS_DAC2CH1                                     \
  (COMP_CFGRx_INMSEL_3) /*!< Comparator input minus connected to  (temp sensor \
                           which is exist in ADC for COMP1, DAC2_CH1 for       \
                           COMP2) */
#define LL_COMP_INPUT_MINUS_VBAT_VDDAP                                         \
  (COMP_CFGRx_INMSEL_3 |                                                       \
   COMP_CFGRx_INMSEL_0) /*!< Comparator input minus connected to  (VBAT/4 for  \
                           COMP1, VDDAP for COMP2) */
#endif
/**
 * @}
 */
...
#define LL_COMP_HYSTERESIS_HIGH                                                \
  (COMP_CFGRx_HYST_1 | COMP_CFGRx_HYST_0) /*!< Hysteresis level high */
/**
 * @}
 */
...
#define LL_COMP_OUTPUTPOL_INVERTED                                             \
  (COMP_CFGRx_POLARITY) /*!< COMP output polarity is inverted: comparator      \
...
#define LL_COMP_BLANKINGSRC_TIM1_OC5                                           \
  (COMP_CFGRx_BLANKING_0) /*!< Comparator output blanking source TIM1 OC5      \
                             (common to all COMP instances: COMP1, COMP2) */
#define LL_COMP_BLANKINGSRC_TIM2_OC3                                           \
  (COMP_CFGRx_BLANKING_1) /*!< Comparator output blanking source TIM2 OC3      \
                             (common to all COMP instances: COMP1, COMP2) */
#define LL_COMP_BLANKINGSRC_TIM3_OC3                                           \
  (COMP_CFGRx_BLANKING_0 |                                                     \
   COMP_CFGRx_BLANKING_1) /*!< Comparator output blanking source TIM3 OC3      \
                             (common to all COMP instances: COMP1, COMP2) */
#define LL_COMP_BLANKINGSRC_TIM3_OC4                                           \
  (COMP_CFGRx_BLANKING_2) /*!< Comparator output blanking source TIM3 OC4      \
                             (common to all COMP instances: COMP1, COMP2) */
#define LL_COMP_BLANKINGSRC_TIM8_OC5                                           \
  (COMP_CFGRx_BLANKING_2 |                                                     \
   COMP_CFGRx_BLANKING_0) /*!< Comparator output blanking source TIM8 OC5      \
                             (common to all COMP instances: COMP1, COMP2) */
#define LL_COMP_BLANKINGSRC_TIM15_OC1                                          \
  (COMP_CFGRx_BLANKING_2 |                                                     \
   COMP_CFGRx_BLANKING_1) /*!< Comparator output blanking source TIM15 OC1     \
                             (common to all COMP instances: COMP1, COMP2) */
/**
 * @}
 */
 ...
 * @}
 */
/** @defgroup COMP_LL_EC_OUTPUT_BKIN_TIMER Comparator output - Output to BKIN
 * timer
 * @{
 */
#define LL_COMP_AF_PA6                                                         \
  COMP_OR_AFOPA6 /*!< Comparator Alternate Function PA6 source selected to     \
                    timer BKIN input  */
#define LL_COMP_AF_PA8                                                         \
  COMP_OR_AFOPA8 /*!< Comparator Alternate Function PA8 source selected to     \
                    timer BKIN input  */
#define LL_COMP_AF_PB12                                                        \
  COMP_OR_AFOPB12 /*!< Comparator Alternate Function PB12 source selected to   \
                     timer BKIN input */
#define LL_COMP_AF_PE6                                                         \
  COMP_OR_AFOPE6 /*!< Comparator Alternate Function PE6 source selected to     \
                    timer BKIN input  */
#define LL_COMP_AF_PE15                                                        \
  COMP_OR_AFOPE15 /*!< Comparator Alternate Function PE15 source selected to   \
                     timer BKIN input */
#define LL_COMP_AF_PG2                                                         \
  COMP_OR_AFOPG2 /*!< Comparator Alternate Function PG2 source selected to     \
                    timer BKIN input  */
#define LL_COMP_AF_PG3                                                         \
  COMP_OR_AFOPG3 /*!< Comparator Alternate Function PG3 source selected to     \
                    timer BKIN input  */
#define LL_COMP_AF_PG4                                                         \
  COMP_OR_AFOPG4 /*!< Comparator Alternate Function PG4 source selected to     \
                    timer BKIN input  */
#define LL_COMP_AF_PI1                                                         \
  COMP_OR_AFOPI1 /*!< Comparator Alternate Function PI1 source selected to     \
                    timer BKIN input  */
#define LL_COMP_AF_PI4                                                         \
  COMP_OR_AFOPI4 /*!< Comparator Alternate Function PI4 source selected to     \
                    timer BKIN input  */
#define LL_COMP_AF_PK2                                                         \
  COMP_OR_AFOPK2 /*!< Comparator Alternate Function PK2 source selected to     \
                    timer BKIN input  */
/**
 * @}
 */
...
#if defined(COMP_CFGRx_INP2SEL)
  return (
      uint32_t)(READ_BIT(COMPx->CFGR, COMP_CFGRx_INPSEL | COMP_CFGRx_INP2SEL));
#else
...
__STATIC_INLINE uint32_t LL_COMP_GetInputMinus(const COMP_TypeDef *COMPx) {
  return (uint32_t)(READ_BIT(
      COMPx->CFGR, COMP_CFGRx_INMSEL | COMP_CFGRx_SCALEN | COMP_CFGRx_BRGEN));
}
 ...
 */
__STATIC_INLINE void
LL_COMP_SetOutputAlternateFunction(const COMP_TypeDef *COMPx,
                                   uint32_t CompAFx) {
  MODIFY_REG(COMP12->OR, 0x7FFUL,
 ...
 */
__STATIC_INLINE uint32_t
LL_COMP_GetOutputAlternateFunction(const COMP_TypeDef *COMPx) {
...
__STATIC_INLINE uint32_t LL_COMP_IsEnabled(const COMP_TypeDef *COMPx) {
  return ((READ_BIT(COMPx->CFGR, COMP_CFGRx_EN) == (COMP_CFGRx_EN)) ? 1UL
                                                                    : 0UL);
}
...
__STATIC_INLINE uint32_t LL_COMP_IsLocked(const COMP_TypeDef *COMPx) {
  return ((READ_BIT(COMPx->CFGR, COMP_CFGRx_LOCK) == (COMP_CFGRx_LOCK)) ? 1UL
                                                                        : 0UL);
}
...
LL_COMP_IsEnabledIT_OutputTrig(const COMP_TypeDef *COMPx) {
  return ((READ_BIT(COMPx->CFGR, COMP_CFGRx_ITEN) == (COMP_CFGRx_ITEN)) ? 1UL
                                                                        : 0UL);
}
