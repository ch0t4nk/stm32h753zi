...
typedef struct {
  ...
  uint32_t
      PreambleTypeMask; /*!< Specifies whether The preamble type bits are copied
                           or not into the received frame. This parameter can be
                           a value of @ref SPDIFRX_PT_Mask */
  ...
  FunctionalState
      SymbolClockGen; /*!< Enable/Disable the SPDIFRX Symbol Clock generation.
                           This parameter can be set to Enable or Disable */

  FunctionalState
      BackupSymbolClockGen; /*!< Enable/Disable the SPDIFRX Backup Symbol Clock
                               generation. This parameter can be set to Enable
                               or Disable */
} SPDIFRX_InitTypeDef;
...
#endif /* USE_HAL_SPDIFRX_REGISTER_CALLBACKS */
{
  ...
  void (*CxHalfCpltCallback)(
      struct __SPDIFRX_HandleTypeDef *hspdif); /*!< SPDIFRX Control flow half
                                                  completed callback */
  void (*CxCpltCallback)(
      struct __SPDIFRX_HandleTypeDef
