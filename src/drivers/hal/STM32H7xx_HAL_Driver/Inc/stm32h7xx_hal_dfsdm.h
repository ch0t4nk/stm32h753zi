...
typedef struct {
  uint32_t Multiplexer; /*!< Input is external serial inputs, internal register
                           or ADC output. This parameter can be a value of @ref
...
typedef struct {
  uint32_t Trigger; /*!< Trigger used to start injected conversion: software,
                       external or synchronous. This parameter can be a value of
                       @ref DFSDM_Filter_Trigger */
  FunctionalState
...
#define DFSDM_FILTER_EXT_TRIG_LPTIM2_OUT                                       \
  (DFSDM_FLTCR1_JEXTSEL_4 | DFSDM_FLTCR1_JEXTSEL_3 | DFSDM_FLTCR1_JEXTSEL_1 |  \
   DFSDM_FLTCR1_JEXTSEL_0) /*!< For all DFSDM filters */
...
#define DFSDM_FILTER_EXT_TRIG_COMP1_OUT                                        \
  (DFSDM_FLTCR1_JEXTSEL_4 | DFSDM_FLTCR1_JEXTSEL_3 | DFSDM_FLTCR1_JEXTSEL_2 |  \
   DFSDM_FLTCR1_JEXTSEL_0)
#define DFSDM_FILTER_EXT_TRIG_COMP2_OUT                                        \
  (DFSDM_FLTCR1_JEXTSEL_4 | DFSDM_FLTCR1_JEXTSEL_3 | DFSDM_FLTCR1_JEXTSEL_2 |  \
   DFSDM_FLTCR1_JEXTSEL_1)
#elif (STM32H7_DEV_ID == 0x483UL)
#define DFSDM_FILTER_EXT_TRIG_TIM23_TRGO                                       \
  (DFSDM_FLTCR1_JEXTSEL_3 | DFSDM_FLTCR1_JEXTSEL_1 | DFSDM_FLTCR1_JEXTSEL_0)
#define DFSDM_FILTER_EXT_TRIG_TIM24_TRGO                                       \
  (DFSDM_FLTCR1_JEXTSEL_3 | DFSDM_FLTCR1_JEXTSEL_2)
...
#define IS_DFSDM1_CHANNEL_INSTANCE(INSTANCE)                                   \
  (((INSTANCE) == DFSDM1_Channel0) || ((INSTANCE) == DFSDM1_Channel1) ||       \
   ...
   ((INSTANCE) == DFSDM1_Channel4) || ((INSTANCE) == DFSDM1_Channel5) ||       \
...
#define IS_DFSDM1_FILTER_INSTANCE(INSTANCE)                                    \
  (((INSTANCE) == DFSDM1_Filter0) || ((INSTANCE) == DFSDM1_Filter1) ||         \
   ((INSTANCE) == DFSDM1_Filter2) || ((INSTANCE) == DFSDM1_Filter3) ||         \
   ((INSTANCE) == DFSDM1_Filter4) || ((INSTANCE) == DFSDM1_Filter5) ||         \
   ((INSTANCE) == DFSDM1_Filter6) || ((INSTANCE) == DFSDM1_Filter7))
