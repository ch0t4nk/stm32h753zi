...
#define DAC_TRIGGER_NONE                                                       \
  0x00000000U /*!< Conversion is automatic once the DAC_DHRxxxx register has   \
...
#define DAC_TRIGGER_HR1_TRGO1                                                  \
  (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_0 |                                           \
   DAC_CR_TEN1) /*!< HR1 TRGO1 selected as external conversion trigger for DAC \
                   channel */
#define DAC_TRIGGER_HR1_TRGO2                                                  \
  (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 |                                           \
   DAC_CR_TEN1) /*!< HR1 TRGO2 selected as external conversion trigger for DAC \
                   channel */
#endif          /* HRTIM12 */
#define DAC_TRIGGER_LPTIM1_OUT                                                 \
  (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 |                          \
   DAC_CR_TEN1) /*!< LPTIM1 OUT TRGO selected as external conversion trigger   \
                   for DAC channel */
#define DAC_TRIGGER_LPTIM2_OUT                                                 \
  (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 |                                           \
   DAC_CR_TEN1) /*!< LPTIM2 OUT TRGO selected as external conversion trigger   \
                   for DAC channel */
...
#define DAC_TRIGGER_T23_TRGO                                                   \
  (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 |                          \
   DAC_CR_TEN1) /*!< TIM23 TRGO selected as external conversion trigger for    \
                   DAC channel */
#endif          /* TIM23 */
#if defined(TIM24)
#define DAC_TRIGGER_T24_TRGO                                                   \
  (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 | DAC_CR_TSEL1_0 |         \
   DAC_CR_TEN1) /*!< TIM24 TRGO selected as external conversion trigger for    \
                   DAC channel */
#endif          /* TIM24 */
#if defined(DAC2)
#define DAC_TRIGGER_LPTIM3_OUT                                                 \
  (DAC_CR_TSEL1_3 | DAC_CR_TSEL1_2 | DAC_CR_TSEL1_1 |                          \
   DAC_CR_TEN1) /*!< LPTIM3 OUT TRGO selected as external conversion trigger   \
                   for DAC channel */
#endif          /* DAC2 */
