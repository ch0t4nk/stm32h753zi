...
typedef struct {
  ...
  uint32_t
      RxFifo0ElmtsNbr; /*!< Specifies the number of Rx FIFO0 Elements.
                            This parameter must be a number between 0 and 64 */
  ...
  uint32_t
      RxFifo1ElmtsNbr; /*!< Specifies the number of Rx FIFO 1 Elements.
                            This parameter must be a number between 0 and 64 */
  ...
  uint32_t
      RxBuffersNbr; /*!< Specifies the number of Dedicated Rx Buffer elements.
                         This parameter must be a number between 0 and 64 */
  ...
  uint32_t
      TxBuffersNbr; /*!< Specifies the number of Dedicated Tx Buffers.
                         This parameter must be a number between 0 and 32 */

  uint32_t TxFifoQueueElmtsNbr; /*!< Specifies the number of Tx Buffers used for
                                   Tx FIFO/Queue. This parameter must be a
...
typedef struct {
  ...
  uint32_t ClockDivider; /*!< Specifies the FDCAN kernel clock divider when the
                            clock calibration is bypassed. This parameter can be
                            a value of @ref FDCAN_clock_divider            */

  uint32_t
      MinOscClkPeriods; /*!< Configures the minimum number of periods in two CAN
                           bit times. The actual configured number of periods is
                           MinOscClkPeriods x 32. This parameter must be a
...
typedef struct {
  ...
  uint32_t FilterType; /*!< Specifies the filter type.
                          ...
                          FDCAN_EXT_FILTER_RANGE_NO_EIDM is permitted only when
                          IdType is FDCAN_EXTENDED_ID. This parameter is ignored
                          if FilterConfig is set to FDCAN_FILTER_TO_RXBUFFER */
  ...
  uint32_t RxBufferIndex; /*!< Contains the index of the Rx buffer in which the
                               ...
                               This parameter is ignored if FilterConfig is
                             different from FDCAN_FILTER_TO_RXBUFFER */

  uint32_t IsCalibrationMsg; /*!< Specifies whether the filter is configured for
                                  calibration messages.
                                  This parameter is ignored if FilterConfig is
                                different from FDCAN_FILTER_TO_RXBUFFER. This
                                parameter can be:
                                   - 0 : ordinary message
  ...
  uint32_t
      FilterIndex; /*!< Specifies the index of matching Rx acceptance filter
                      element. This parameter must be a number between:
                         - 0 and 127, if IdType is FDCAN_STANDARD_ID
                         - 0 and 63, if IdType is FDCAN_EXTENDED_ID
                        When the frame is a Non-Filter matching frame, this
                      parameter is unused. */
...
typedef struct {
  ...
  uint32_t
      GapEnable; /*!< Specifies the FDCAN TT Operation.
  ...
  uint32_t SyncDevLimit; /*!< Specifies the Synchronization Deviation Limit SDL
                            of the TUR numerator : TUR = (Numerator +/- SDL) /
                            Denominator. With : SDL = 2^(SyncDevLimit+5). This
                            parameter must be a number between 0 and 7 */
  ...
  uint32_t ExternalClkSync; /*!< Enable or disable External Clock
                               Synchronization. This parameter can be a value of
                               @ref FDCAN_TT_external_clk_sync. This parameter
                               is ignored if OperationMode is set to
                                 FDCAN_TT_COMMUNICATION_LEVEL1 */

  uint32_t
      AppWdgLimit; /*!< Specifies the Application Watchdog Limit : maximum time
                      after which the application has to serve the application
                      watchdog. The application watchdog is incremented once
                      each 256 NTUs. The application watchdog can be disabled by
                      setting AppWdgLimit to 0. This parameter must be a number
  ...
  uint32_t ClockCalibration; /*!< Enable or disable Automatic Clock Calibration.
                                  This parameter can be a value of @ref
                                FDCAN_TT_auto_clk_calibration. This parameter is
  ...
  uint32_t BasicCyclesNbr; /*!< Specifies the number of basic cycles in the
  ...
  uint32_t
      TxEnableWindow; /*!< Specifies the length of Tx enable window in NTUs.
  ...
  uint32_t ExpTxTrigNbr; /*!< Specifies the number of expected Tx_Triggers in
                            ...
                            arbitrating windows. This parameter must be a number
                            between 0 and 4095                       */

  uint32_t TURNumerator; /*!< Specifies the TUR (Time Unit Ratio) numerator.
                              It is advised to set this parameter to the largest
                            applicable value. This parameter must be a number
                            between 0x10000 and 0x1FFFF              */

  uint32_t TURDenominator; /*!< Specifies the TUR (Time Unit Ratio) denominator.
                                This parameter must be a number between 0x0001
                              and 0x3FFF                */

  uint32_t
      TriggerMemoryNbr; /*!< Specifies the number of trigger memory elements.
                             This parameter must be a number between 0 and 64 */
...
typedef struct {
  uint32_t
      TriggerIndex; /*!< Specifies the trigger which will be configured.
                         This parameter must be a number between 0 and 63 */

  uint32_t TimeMark; /*!< Specifies the cycle time for which the trigger becomes
                        active. This parameter must be a number between 0 and
                        0xFFFF                             */
  ...
  uint32_t
      StartCycle; /*!< Specifies the index of the first cycle in which the
                     trigger becomes active. This parameter is ignored if
                     RepeatFactor is set to FDCAN_TT_REPEAT_EVERY_CYCLE. This
                     parameter must be a number between 0 and RepeatFactor */

  uint32_t
      TmEventInt; /*!< Enable or disable the internal time mark event.
                       If enabled, FDCAN_TT_FLAG_TRIG_TIME_MARK flag is set when
                     trigger memory element becomes active. This parameter can
                     be a value of @ref FDCAN_TT_Time_Mark_Event_Internal */
  ...
  uint32_t TmEventExt; /*!< Enable or disable the external time mark event.
                          ...
                          becomes active. This parameter can be a value of @ref
                          FDCAN_TT_Time_Mark_Event_External          */
  ...
  uint32_t
      FilterType; /*!< Specifies the filter identifier type.
                       This parameter can be a value of @ref FDCAN_id_type */

  uint32_t TxBufferIndex; /*!< Specifies the index of the Tx buffer for which
                             the trigger is valid. This parameter can be a value
                             of @ref FDCAN_Tx_location. This parameter is taken
                             in consideration only if the trigger is configured
                             for transmission. */

  uint32_t FilterIndex; /*!< Specifies the filter for which the trigger is
                           valid. This parameter is taken in consideration only
                           if the trigger is configured for reception. This
...
typedef struct {
  ...
  uint32_t
      GTimeQuality; /*!< Specifies the Quality of Global Time Phase.
  ...
  uint32_t
      ClockQuality; /*!< Specifies the Quality of Clock Speed.
                         This parameter is only relevant in Level 0 and Level 2,
  ...
  uint32_t
      RefTrigOffset; /*!< Specifies the Actual Reference Trigger Offset Value.
  ...
  uint32_t
      MasterPriority; /*!< Specifies the Priority of actual Time Master.
  ...
  uint32_t
      WaitForEvt; /*!< Specifies whether a Gap is announced.
                       This parameter can be:
  ...
  uint32_t
      AppWdgEvt; /*!< Specifies the Application Watchdog State.
                      This parameter can be:
  ...
  uint32_t ECSPending; /*!< Specifies the External Clock Synchronization State.
                            This parameter can be:
                             ...
                             - 1 : Node waits for external clock synchronization
                          to take effect           */
...
#endif /* USE_HAL_FDCAN_REGISTER_CALLBACKS */
{
  ...
  void (*RxBufferNewMessageCallback)(
      struct __FDCAN_HandleTypeDef
          *hfdcan); /*!< FDCAN Rx Buffer New Message callback      */
  ...
  void (*TT_StopWatchCallback)(
      struct __FDCAN_HandleTypeDef *hfdcan, uint32_t SWTime,
...
typedef enum {
  ...
  HAL_FDCAN_RX_BUFFER_NEW_MSG_CB_ID =
      0x01U, /*!< FDCAN Rx buffer new message callback ID */
  HAL_FDCAN_HIGH_PRIO_MESSAGE_CB_ID =
      0x02U, /*!< FDCAN High priority message callback ID */
  HAL_FDCAN_TIMESTAMP_WRAPAROUND_CB_ID =
      0x03U, /*!< FDCAN Timestamp wraparound callback ID  */
  HAL_FDCAN_TIMEOUT_OCCURRED_CB_ID =
      0x04U, /*!< FDCAN Timeout occurred callback ID      */
...
typedef void (*pFDCAN_TT_TimeMarkCallbackTypeDef)(
    FDCAN_HandleTypeDef *hfdcan,
    uint32_t
        TTTimeMarkITs); /*!< pointer to TT Time Mark FDCAN callback function */
typedef void (*pFDCAN_TT_StopWatchCallbackTypeDef)(
    FDCAN_HandleTypeDef *hfdcan, uint32_t SWTime,
    uint32_t
        SWCycleCount); /*!< pointer to TT Stop Watch FDCAN callback function */
...
#define HAL_FDCAN_ERROR_TT_GLOBAL_TIME                                         \
  FDCAN_TTIR_GTE /*!< Global Time Error : Synchronization deviation exceeded   \
                    limit           */
#define HAL_FDCAN_ERROR_TT_TX_UNDERFLOW                                        \
  FDCAN_TTIR_TXU /*!< Tx Count Underflow : Less Tx trigger than expected in    \
                    one matrix cycle */
...
#define FDCAN_FILTER_TO_RXBUFFER                                               \
  ((uint32_t)0x00000007U) /*!< Store into Rx Buffer, configuration of          \
                             FilterType ignored */
/**
 * @}
 */
...
#define FDCAN_TT_REF_MESSAGE_ADD_PAYLOAD                                       \
  ((uint32_t)                                                                  \
       FDCAN_TTRMC_RMPS) /*!< Additional payload is taken from Tx Buffer 0 */
/**
 * @}
 */
...
#define FDCAN_TT_TX_REF_TRIGGER                                                \
  ((uint32_t)0x00000000U) /*!< Transmit reference message in strictly          \
...
#define FDCAN_TT_TX_TRIGGER_SINGLE                                             \
  ((uint32_t)0x00000002U) /*!< Start a single transmission in an exclusive     \
                             time window */
#define FDCAN_TT_TX_TRIGGER_CONTINUOUS                                         \
  ((uint32_t)0x00000003U) /*!< Start a continuous transmission in an exclusive \
                             time window */
#define FDCAN_TT_TX_TRIGGER_ARBITRATION                                        \
  ((uint32_t)0x00000004U) /*!< Start a transmission in an arbitration time     \
                             window */
#define FDCAN_TT_TX_TRIGGER_MERGED                                             \
  ((uint32_t)0x00000005U) /*!< Start a merged arbitration window */
#define FDCAN_TT_WATCH_TRIGGER                                                 \
  ((uint32_t)0x00000006U) /*!< Check for missing reference messages in         \
                             strictly time-triggered operation */
#define FDCAN_TT_WATCH_TRIGGER_GAP                                             \
  ((uint32_t)0x00000007U) /*!< Check for missing reference messages in         \
...
#define FDCAN_TT_TM_GEN_INTERNAL_EVENT                                         \
  ((uint32_t)0x00000020U) /*!< Internal event is generated when trigger        \
                             becomes active */
/**
 * @}
 */
...
#define FDCAN_TT_TM_GEN_EXTERNAL_EVENT                                         \
  ((uint32_t)0x00000010U) /*!< External event (pulse) is generated when        \
...
#define FDCAN_TT_EXT_CLK_SYNC_DISABLE                                          \
  ((uint32_t)0x00000000U) /*!< External clock synchronization in Level 0,2     \
                             disabled */
#define FDCAN_TT_EXT_CLK_SYNC_ENABLE                                           \
  ((uint32_t)FDCAN_TTOCF_EECS) /*!< External clock synchronization in Level    \
                                  0,2 enabled  */
/**
 * @}
 */
...
#define FDCAN_TT_GLOB_TIME_FILT_ENABLE                                         \
  ((uint32_t)                                                                  \
       FDCAN_TTOCF_EGTF) /*!< Global time filtering in Level 0,2 enabled  */
/**
 * @}
 */
...
#define FDCAN_TT_AUTO_CLK_CALIB_DISABLE                                        \
  ((uint32_t)0x00000000U) /*!< Automatic clock calibration in Level 0,2        \
                             disabled */
#define FDCAN_TT_AUTO_CLK_CALIB_ENABLE                                         \
  ((uint32_t)FDCAN_TTOCF_ECC) /*!< Automatic clock calibration in Level 0,2    \
                                 enabled  */
/**
 * @}
 */
...
#define FDCAN_TT_STOP_WATCH_CYCLE_TIME                                         \
  ((uint32_t)0x00000008U) /*!< Actual value of cycle time is copied to Capture \
                             Time register (TTCPT.SWV)  */
#define FDCAN_TT_STOP_WATCH_LOCAL_TIME                                         \
  ((uint32_t)0x00000010U) /*!< Actual value of local time is copied to Capture \
                             Time register (TTCPT.SWV)  */
#define FDCAN_TT_STOP_WATCH_GLOBAL_TIME                                        \
  ((uint32_t)0x00000018U) /*!< Actual value of global time is copied to        \
                             Capture Time register (TTCPT.SWV) */
/**
 * @}
 */
...
#define FDCAN_TT_STOP_WATCH_RISING                                             \
  ((uint32_t)0x00000000U) /*!< Selected stop watch source is captured at       \
                             rising edge of fdcan1_swt  */
#define FDCAN_TT_STOP_WATCH_FALLING                                            \
  ((uint32_t)0x00000004U) /*!< Selected stop watch source is captured at       \
                             falling edge of fdcan1_swt */
/**
 * @}
 */
...
#define FDCAN_TT_REG_TIMEMARK_CYC_TIME                                         \
  ((uint32_t)0x00000040U) /*!< Register Time Mark Interrupt if Time Mark =     \
                             cycle time  */
#define FDCAN_TT_REG_TIMEMARK_LOC_TIME                                         \
  ((uint32_t)0x00000080U) /*!< Register Time Mark Interrupt if Time Mark =     \
                             local time  */
#define FDCAN_TT_REG_TIMEMARK_GLO_TIME                                         \
  ((uint32_t)0x000000C0U) /*!< Register Time Mark Interrupt if Time Mark =     \
                             global time */
/**
 * @}
 */
...
HAL_StatusTypeDef HAL_FDCAN_RegisterTTGlobalTimeCallback(
    FDCAN_HandleTypeDef *hfdcan, pFDCAN_TT_GlobalTimeCallbackTypeDef pCallback);
HAL_StatusTypeDef
