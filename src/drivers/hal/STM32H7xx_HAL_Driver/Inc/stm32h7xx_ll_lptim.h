...
#define LL_LPTIM_TRIG_SOURCE_LPTIM3                                            \
  LPTIM_CFGR_TRIGSEL_0 /*!<External input trigger is connected to LPTIM3       \
                          output*/
#define LL_LPTIM_TRIG_SOURCE_LPTIM4                                            \
  LPTIM_CFGR_TRIGSEL_1 /*!<External input trigger is connected to LPTIM4       \
                          output*/
#define LL_LPTIM_TRIG_SOURCE_LPTIM5                                            \
  (LPTIM_CFGR_TRIGSEL_1 |                                                      \
   LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to LPTIM5     \
                            output*/
#define LL_LPTIM_TRIG_SOURCE_SAI1_FS_A                                         \
  LPTIM_CFGR_TRIGSEL_2 /*!<External input trigger is connected to SAI1 FS A    \
                          output*/
#define LL_LPTIM_TRIG_SOURCE_SAI1_FS_B                                         \
  (LPTIM_CFGR_TRIGSEL_2 |                                                      \
   LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to SAI1 FS B  \
                            output*/
#define LL_LPTIM_TRIG_SOURCE_SAI2_FS_A                                         \
  LPTIM_CFGR_TRIGSEL_2 /*!<External input trigger is connected to SAI2 FS A    \
                          output*/
#define LL_LPTIM_TRIG_SOURCE_SAI2_FS_B                                         \
  (LPTIM_CFGR_TRIGSEL_2 |                                                      \
   LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to SAI2 FS B  \
                            output*/
#define LL_LPTIM_TRIG_SOURCE_SAI4_FS_A                                         \
  (LPTIM_CFGR_TRIGSEL_1 |                                                      \
   LPTIM_CFGR_TRIGSEL_0) /*!<External input trigger is connected to SAI4 FS A  \
                            output*/
#define LL_LPTIM_TRIG_SOURCE_SAI4_FS_B                                         \
  LPTIM_CFGR_TRIGSEL_2 /*!<External input trigger is connected to SAI4 FS B    \
                          output*/
