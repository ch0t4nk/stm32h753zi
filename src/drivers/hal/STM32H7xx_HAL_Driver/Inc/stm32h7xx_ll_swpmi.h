...
typedef struct {
  ...
  uint32_t
      RxBufferingMode; /*!< Specifies the reception buffering mode.
                            This parameter can be a value of @ref
...
#define LL_SWPMI_SW_BUFFER_TX_SINGLE                                           \
  ((uint32_t)0x00000000) /*!< Single software buffer mode for transmission */
...
#define LL_SWPMI_VOLTAGE_CLASS_C                                               \
  ((uint32_t)0x00000000) /*!< SWPMI_IO uses directly VDD voltage to operate in \
                            class C          */
#define LL_SWPMI_VOLTAGE_CLASS_B                                               \
  SWPMI_OR_CLASS /*!< SWPMI_IO uses an internal voltage regulator to operate   \
                    in class B */
/**
 * @}
 */
...
LL_SWPMI_GetReceptionMode(const SWPMI_TypeDef *SWPMIx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsEnabledTransceiver(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->CR, SWPMI_CR_SWPEN) == (SWPMI_CR_SWPEN)) ? 1UL
                                                                     : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SWPMI_IsActivated(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->CR, SWPMI_CR_SWPACT) == (SWPMI_CR_SWPACT)) ? 1UL
                                                                       : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsActiveFlag_RXBF(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->ISR, SWPMI_ISR_RXBFF) == (SWPMI_ISR_RXBFF)) ? 1UL
                                                                        : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsActiveFlag_TXBE(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->ISR, SWPMI_ISR_TXBEF) == (SWPMI_ISR_TXBEF)) ? 1UL
                                                                        : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsActiveFlag_RXNE(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->ISR, SWPMI_ISR_RXNE) == (SWPMI_ISR_RXNE)) ? 1UL
                                                                      : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsActiveFlag_TXE(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->ISR, SWPMI_ISR_TXE) == (SWPMI_ISR_TXE)) ? 1UL
                                                                    : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SWPMI_IsActiveFlag_TC(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->ISR, SWPMI_ISR_TCF) == (SWPMI_ISR_TCF)) ? 1UL
                                                                    : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SWPMI_IsActiveFlag_SR(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->ISR, SWPMI_ISR_SRF) == (SWPMI_ISR_SRF)) ? 1UL
                                                                    : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsActiveFlag_SUSP(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->ISR, SWPMI_ISR_SUSP) == (SWPMI_ISR_SUSP)) ? 1UL
                                                                      : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsActiveFlag_RDYF(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->ISR, SWPMI_ISR_RDYF) == (SWPMI_ISR_RDYF)) ? 1UL
                                                                      : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SWPMI_IsEnabledIT_RDY(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->IER, SWPMI_IER_RDYIE) == (SWPMI_IER_RDYIE)) ? 1UL
                                                                        : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SWPMI_IsEnabledIT_SR(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->IER, SWPMI_IER_SRIE) == (SWPMI_IER_SRIE)) ? 1UL
                                                                      : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SWPMI_IsEnabledIT_TC(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->IER, SWPMI_IER_TCIE) == (SWPMI_IER_TCIE)) ? 1UL
                                                                      : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SWPMI_IsEnabledIT_TX(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->IER, SWPMI_IER_TIE) == (SWPMI_IER_TIE)) ? 1UL
                                                                    : 0UL);
}
...
__STATIC_INLINE uint32_t LL_SWPMI_IsEnabledIT_RX(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->IER, SWPMI_IER_RIE) == (SWPMI_IER_RIE)) ? 1UL
                                                                    : 0UL);
}
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsEnabledIT_TXUNR(const SWPMI_TypeDef *SWPMIx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsEnabledIT_RXOVR(const SWPMI_TypeDef *SWPMIx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsEnabledIT_RXBER(const SWPMI_TypeDef *SWPMIx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsEnabledIT_TXBE(const SWPMI_TypeDef *SWPMIx) {
 ...
 */
__STATIC_INLINE uint32_t
LL_SWPMI_IsEnabledIT_RXBF(const SWPMI_TypeDef *SWPMIx) {
...
LL_SWPMI_IsEnabledDMAReq_RX(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->CR, SWPMI_CR_RXDMA) == (SWPMI_CR_RXDMA)) ? 1UL
                                                                     : 0UL);
}
...
LL_SWPMI_IsEnabledDMAReq_TX(const SWPMI_TypeDef *SWPMIx) {
  return ((READ_BIT(SWPMIx->CR, SWPMI_CR_TXDMA) == (SWPMI_CR_TXDMA)) ? 1UL
                                                                     : 0UL);
}
