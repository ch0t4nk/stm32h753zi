 ...
 *         This parameter can be one or a combination of @ref
 * SDMMC_LL_Interrupt_sources.
 * @retval None
 */
 ...
 * @{
 */
HAL_StatusTypeDef HAL_SDIO_ReadDirect(SDIO_HandleTypeDef *hsdio,
                                      HAL_SDIO_DirectCmd_TypeDef *Argument,
                                      uint8_t *pData);
HAL_StatusTypeDef HAL_SDIO_WriteDirect(SDIO_HandleTypeDef *hsdio,
                                       HAL_SDIO_DirectCmd_TypeDef *Argument,
                                       uint8_t Data);

HAL_StatusTypeDef HAL_SDIO_ReadExtended(SDIO_HandleTypeDef *hsdio,
                                        HAL_SDIO_ExtendedCmd_TypeDef *Argument,
                                        uint8_t *pData, uint32_t Size_byte,
                                        uint32_t Timeout_Ms);

HAL_StatusTypeDef HAL_SDIO_WriteExtended(SDIO_HandleTypeDef *hsdio,
                                         HAL_SDIO_ExtendedCmd_TypeDef *Argument,
                                         uint8_t *pData, uint32_t Size_byte,
                                         uint32_t Timeout_Ms);
