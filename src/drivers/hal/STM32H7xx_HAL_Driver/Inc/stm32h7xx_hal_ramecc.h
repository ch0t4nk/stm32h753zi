...
#if (USE_HAL_RAMECC_REGISTER_CALLBACKS == 1)
  void (*DetectErrorCallback)(struct __RAMECC_HandleTypeDef *
                                  hramecc); /*!< RAMECC Error Detect callback */
#endif /* USE_HAL_RAMECC_REGISTER_CALLBACKS */
 ...
 * @{
 */
#define HAL_RAMECC_NO_ERROR                                                    \
  0x00000000U /*!< RAMECC No Error Detected                      */
#define HAL_RAMECC_SINGLEERROR_DETECTED                                        \
  0x00000001U /*!< RAMECC Single Error Detected                  */
#define HAL_RAMECC_DOUBLEERROR_DETECTED                                        \
  0x00000002U /*!< RAMECC Double Error Detected                  */
/**
 * @}
 */
...
#define __HAL_RAMECC_ENABLE_GLOBAL_IT(__HANDLE__, __INTERRUPT__)               \
  ((((RAMECC_TypeDef *)((uint32_t)(__HANDLE__)->Instance & 0xFFFFFF00U))       \
 ...
 *           @arg RAMECC_IT_GLOBAL_ENABLE         : Global interrupt enable
 * mask.
 *           @arg RAMECC_IT_GLOBAL_SINGLEERR_R    : Global ECC single error
 * interrupt enable.
 *           @arg RAMECC_IT_GLOBAL_DOUBLEERR_R    : Global ECC double error
 * interrupt enable.
 *           @arg RAMECC_IT_GLOBAL_DOUBLEERR_W    : Global ECC double error on
 * byte write (BW) interrupt enable.
 *           @arg RAMECC_IT_GLOBAL_ALL            : All Global ECC interrupts
 * enable mask.
 *           @arg RAMECC_IT_MONITOR_SINGLEERR_R   : Monitor ECC single error
 * interrupt enable.
 *           @arg RAMECC_IT_MONITOR_DOUBLEERR_R   : Monitor ECC double error
 * interrupt enable.
 *           @arg RAMECC_IT_MONITOR_DOUBLEERR_W   : Monitor ECC double error on
 * byte write (BW) interrupt enable.
...
#define __HAL_RAMECC_ENABLE_IT(__HANDLE__, __INTERRUPT__)                      \
  ((IS_RAMECC_GLOBAL_INTERRUPT(__INTERRUPT__))                                 \
       ? (__HAL_RAMECC_ENABLE_GLOBAL_IT((__HANDLE__), (__INTERRUPT__)))        \
...
#define __HAL_RAMECC_DISABLE_IT(__HANDLE__, __INTERRUPT__)                     \
  ((IS_RAMECC_GLOBAL_INTERRUPT(__INTERRUPT__))                                 \
       ? (__HAL_RAMECC_DISABLE_GLOBAL_IT((__HANDLE__), (__INTERRUPT__)))       \
...
#define __HAL_RAMECC_GET_MONITOR_IT_SOURCE(__HANDLE__, __INTERRUPT__)          \
  ((((__HANDLE__)->Instance->CR) & ((__INTERRUPT__) & ~RAMECC_IT_GLOBAL_ID))   \
       ? SET                                                                   \
       : RESET)
...
#define __HAL_RAMECC_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)                  \
  ((IS_RAMECC_GLOBAL_INTERRUPT(__INTERRUPT__))                                 \
       ? (__HAL_RAMECC_GET_GLOBAL_IT_SOURCE((__HANDLE__), (__INTERRUPT__)))    \
 ...
 *            @arg RAMECC_FLAG_SINGLEERR_R  : RAMECC instance ECC single error
 * detected and corrected flag.
 *            @arg RAMECC_FLAG_DOUBLEERR_R  : RAMECC instance ECC double error
 * detected flag.
 *            @arg RAMECC_FLAG_DOUBLEERR_W  : RAMECC instance ECC double error
 * on byte write (BW) detected flag.
...
/** @defgroup RAMECC_Exported_Functions_Group3 handle Interrupt and Callbacks
 * Functions
...
#if (USE_HAL_RAMECC_REGISTER_CALLBACKS == 1)
HAL_StatusTypeDef
HAL_RAMECC_RegisterCallback(RAMECC_HandleTypeDef *hramecc,
...
uint32_t
HAL_RAMECC_IsECCSingleErrorDetected(const RAMECC_HandleTypeDef *hramecc);
uint32_t
HAL_RAMECC_IsECCDoubleErrorDetected(const RAMECC_HandleTypeDef *hramecc);
/**
 * @}
 */
 ...
 */
HAL_RAMECC_StateTypeDef
HAL_RAMECC_GetState(const RAMECC_HandleTypeDef *hramecc);
