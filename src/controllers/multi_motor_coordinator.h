...
// Map legacy numeric values to canonical SSOT error code ranges defined in
// src/config/error_codes.h. This preserves symbolic names while keeping the
// canonical error bases centralized.
#ifndef MULTI_MOTOR_ERROR_BASE
#define MULTI_MOTOR_ERROR_BASE (ERROR_CODE_SYSTEM_BASE + 0x100)
#endif

#define ERROR_MOTION_ACTIVE                                                   \
    (MULTI_MOTOR_ERROR_BASE + 0x00) /**< Motion already active */
#define ERROR_NO_MOTORS_ENABLED                                               \
    (MULTI_MOTOR_ERROR_BASE + 0x01) /**< No motors enabled for operation */
#define ERROR_SYNC_TIMEOUT                                                    \
    (MULTI_MOTOR_ERROR_BASE + 0x02) /**< Synchronization timeout */
#define ERROR_LOAD_IMBALANCE                                                  \
    (MULTI_MOTOR_ERROR_BASE + 0x03) /**< Load imbalance detected */
#define ERROR_VELOCITY_OUT_OF_RANGE                                           \
    (MULTI_MOTOR_ERROR_BASE + 0x04) /**< Velocity exceeds limits */
