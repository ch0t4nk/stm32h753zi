...
- **STM32H7 I2C Documentation**: Complete I2C peripheral coverage with dual-bus configuration guidance
- **Copilot-Optimized I2C Search**:
  ```bash
  # Search I2C peripheral with semantic targeting
  python3 scripts/search_enhanced_docs.py peripheral I2C --scope STM32H7
  
  # Find I2C HAL functions for master communication
  python3 scripts/search_enhanced_docs.py function HAL_I2C_Master_Transmit --scope STM32H7
  
  # Search dual I2C bus configuration concepts
  python3 scripts/search_enhanced_docs.py concept "i2c_dual_bus" --scope STM32H7
  
  # Find encoder-related implementation patterns
  python3 scripts/search_enhanced_docs.py concept "encoder_feedback" --scope all
  ```
- **Cross-Reference Integration**: Links I2C implementation with motor control and encoder systems
- **Token-Efficient Documentation**: Semantic categorization optimized for Copilot assistance
