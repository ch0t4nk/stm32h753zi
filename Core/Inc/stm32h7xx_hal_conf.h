...
/* HAL Compatibility Definitions (SSOT Fallback) */
/* Note: assert_param is defined later in USE_FULL_ASSERT section */
/* Note: CSI_VALUE, HSI_VALUE, TICK_INT_PRIORITY are defined in their
 * respective sections */
...
#define USE_HAL_ETH_REGISTER_CALLBACKS                                        \
    1U /* ETH register callback enabled     */
#define USE_HAL_FDCAN_REGISTER_CALLBACKS                                      \
    1U /* FDCAN register callback enabled   */
...
#define USE_HAL_WWDG_REGISTER_CALLBACKS                                       \
    1U /* WWDG register callback enabled    */
